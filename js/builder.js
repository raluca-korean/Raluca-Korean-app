(function(){
  ...
  var DATA = {
    ...
    verb: [
      ...
      {ko:'가능하다', ro:'a fi posibil', en:'possible', aliases:['sunt posibil','ești posibil','este posibil','suntem posibili','sunteți posibili','sunt posibili','posibil','e posibil','possible','is possible','are possible'], final:'가능해요', forms:{none:'가능해요',seq:'가능하고',cause1:'가능해서',cause2:'가능하니까',condition:'가능하면',contrast1:'가능하지만',contrast2:'가능한데',purpose:'가능하려고',result:'가능해서 그렇게 되다'}},
      {ko:'가볍다', ro:'a fi ușor', en:'to be light (weight)', aliases:['sunt ușor','ești ușor','este ușor','suntem ușori','sunteți ușori','sunt ușori','ușor','e ușor','lejer','sunt lejer','e lejer','light','is light','are light'], final:'가벼워요', forms:{none:'가벼워요',seq:'가볍고',cause1:'가벼워서',cause2:'가벼우니까',condition:'가벼우면',contrast1:'가볍지만',contrast2:'가벼운데',purpose:'가벼우려고',result:'가벼워서 그렇게 되다'}},
      {ko:'간단하다', ro:'a fi simplu', en:'simple', aliases:['sunt simplu','ești simplu','este simplu','suntem simpli','sunteți simpli','sunt simpli','simplu','e simplu','simple','is simple','are simple'], final:'간단해요', forms:{none:'간단해요',seq:'간단하고',cause1:'간단해서',cause2:'간단하니까',condition:'간단하면',contrast1:'간단하지만',contrast2:'간단한데',purpose:'간단하려고',result:'간단해서 그렇게 되다'}},
      {ko:'감동적이다', ro:'a fi emoționant', en:'to be touching, moving', aliases:['sunt emoționant','ești emoționant','este emoționant','suntem emoționanți','sunteți emoționanți','sunt emoționanți','emoționant','e emoționant','touching','is touching','are touching','moving','is moving','are moving'], final:'감동적이에요', forms:{none:'감동적이에요',seq:'감동적이고',cause1:'감동적이에서',cause2:'감동적이니까',condition:'감동적이면',contrast1:'감동적이지만',contrast2:'감동적인데',purpose:'감동적이려고',result:'감동적이에서 그렇게 되다'}},
      {ko:'강하다', ro:'a fi puternic', en:'strong', aliases:['sunt puternic','ești puternic','este puternic','suntem puternici','sunteți puternici','sunt puternici','puternic','e puternic','strong','is strong','are strong'], final:'강해요', forms:{none:'강해요',seq:'강하고',cause1:'강해서',cause2:'강하니까',condition:'강하면',contrast1:'강하지만',contrast2:'강한데',purpose:'강하려고',result:'강해서 그렇게 되다'}},
      ...
      {ko:'건강하다', ro:'a fi sănătos', en:'healthy', aliases:['sunt sănătos','ești sănătos','este sănătos','suntem sănătoși','sunteți sănătoși','sunt sănătoși','sănătos','e sănătos','healthy','is healthy','are healthy'], final:'건강해요', forms:{none:'건강해요',seq:'건강하고',cause1:'건강해서',cause2:'건강하니까',condition:'건강하면',contrast1:'건강하지만',contrast2:'건강한데',purpose:'건강하려고',result:'건강해서 그렇게 되다'}},
      {ko:'게으르다', ro:'a fi leneș', en:'to be lazy', aliases:['sunt leneș','ești leneș','este leneș','suntem leneși','sunteți leneși','sunt leneși','leneș','e leneș','lazy','is lazy','are lazy'], final:'게을러요', forms:{none:'게을러요',seq:'게으르고',cause1:'게을러서',cause2:'게으르니까',condition:'게으르면',contrast1:'게으르지만',contrast2:'게으른데',purpose:'게으르려고',result:'게을러서 그렇게 되다'}},
      {ko:'겸손하다', ro:'a fi modest', en:'to be humble', aliases:['sunt modest','ești modest','este modest','suntem modești','sunteți modești','sunt modești','modest','e modest','humble','is humble','are humble'], final:'겸손해요', forms:{none:'겸손해요',seq:'겸손하고',cause1:'겸손해서',cause2:'겸손하니까',condition:'겸손하면',contrast1:'겸손하지만',contrast2:'겸손한데',purpose:'겸손하려고',result:'겸손해서 그렇게 되다'}},
      {ko:'경제적이다', ro:'a fi economic', en:'economic', aliases:['sunt economic','ești economic','este economic','suntem economici','sunteți economici','sunt economici','economic','e economic','is economic','are economic'], final:'경제적이에요', forms:{none:'경제적이에요',seq:'경제적이고',cause1:'경제적이에서',cause2:'경제적이니까',condition:'경제적이면',contrast1:'경제적이지만',contrast2:'경제적인데',purpose:'경제적이려고',result:'경제적이에서 그렇게 되다'}},
      {ko:'고맙다', ro:'a fi recunoscător', en:'to be grateful', aliases:['sunt recunoscător','ești recunoscător','este recunoscător','suntem recunoscători','sunteți recunoscători','sunt recunoscători','recunoscător','e recunoscător','grateful','is grateful','are grateful'], final:'고마워요', forms:{none:'고마워요',seq:'고맙고',cause1:'고마워서',cause2:'고마우니까',condition:'고마우면',contrast1:'고맙지만',contrast2:'고마운데',purpose:'고마우려고',result:'고마워서 그렇게 되다'}},
      {ko:'고프다', ro:'a fi flămând', en:'to be hungry', aliases:['sunt flămând','ești flămând','este flămând','suntem flămânzi','sunteți flămânzi','sunt flămânzi','flămând','e flămând','hungry','is hungry','are hungry'], final:'고파요', forms:{none:'고파요',seq:'고프고',cause1:'고파서',cause2:'고프니까',condition:'고프면',contrast1:'고프지만',contrast2:'고픈데',purpose:'고프려고',result:'고파서 그렇게 되다'}},
      {ko:'과학적이다', ro:'a fi științific', en:'scientific', aliases:['sunt științific','ești științific','este științific','suntem științifici','sunteți științifici','sunt științifici','științific','e științific','scientific','is scientific','are scientific'], final:'과학적이에요', forms:{none:'과학적이에요',seq:'과학적이고',cause1:'과학적이에서',cause2:'과학적이니까',condition:'과학적이면',contrast1:'과학적이지만',contrast2:'과학적인데',purpose:'과학적이려고',result:'과학적이에서 그렇게 되다'}},
      {ko:'관대하다', ro:'a fi tolerant', en:'to be generous / tolerant', aliases:['sunt tolerant','ești tolerant','este tolerant','suntem toleranți','sunteți toleranți','sunt toleranți','tolerant','e tolerant','generos','sunt generos','e generos','generous','is generous','are generous','is tolerant','are tolerant'], final:'관대해요', forms:{none:'관대해요',seq:'관대하고',cause1:'관대해서',cause2:'관대하니까',condition:'관대하면',contrast1:'관대하지만',contrast2:'관대한데',purpose:'관대하려고',result:'관대해서 그렇게 되다'}},
      ...
      {ko:'국가적이다', ro:'a fi național', en:'national', aliases:['sunt național','ești național','este național','suntem naționali','sunteți naționali','sunt naționali','național','e național','national','is national','are national'], final:'국가적이에요', forms:{none:'국가적이에요',seq:'국가적이고',cause1:'국가적이에서',cause2:'국가적이니까',condition:'국가적이면',contrast1:'국가적이지만',contrast2:'국가적인데',purpose:'국가적이려고',result:'국가적이에서 그렇게 되다'}},
      {ko:'국제적이다', ro:'a fi internațional', en:'international', aliases:['sunt internațional','ești internațional','este internațional','suntem internaționali','sunteți internaționali','sunt internaționali','internațional','e internațional','international','is international','are international'], final:'국제적이에요', forms:{none:'국제적이에요',seq:'국제적이고',cause1:'국제적이에서',cause2:'국제적이니까',condition:'국제적이면',contrast1:'국제적이지만',contrast2:'국제적인데',purpose:'국제적이려고',result:'국제적이에서 그렇게 되다'}},
      ...
      {ko:'기술적이다', ro:'a fi tehnic', en:'technical', aliases:['sunt tehnic','ești tehnic','este tehnic','suntem tehnici','sunteți tehnici','sunt tehnici','tehnic','e tehnic','technical','is technical','are technical'], final:'기술적이에요', forms:{none:'기술적이에요',seq:'기술적이고',cause1:'기술적이에서',cause2:'기술적이니까',condition:'기술적이면',contrast1:'기술적이지만',contrast2:'기술적인데',purpose:'기술적이려고',result:'기술적이에서 그렇게 되다'}},
      {ko:'길다', ro:'a fi lung', en:'long', aliases:['sunt lung','ești lung','este lung','suntem lungi','sunteți lungi','sunt lungi','lung','e lung','long','is long','are long'], final:'길어요', forms:{none:'길어요',seq:'길고',cause1:'길어서',cause2:'기니까',condition:'기면',contrast1:'길지만',contrast2:'긴데',purpose:'기려고',result:'길어서 그렇게 되다'}},
      {ko:'깊다', ro:'a fi adânc', en:'deep', aliases:['sunt adânc','ești adânc','este adânc','suntem adânci','sunteți adânci','sunt adânci','adânc','e adânc','deep','is deep','are deep'], final:'깊어요', forms:{none:'깊어요',seq:'깊고',cause1:'깊어서',cause2:'깊으니까',condition:'깊으면',contrast1:'깊지만',contrast2:'깊은데',purpose:'깊으려고',result:'깊어서 그렇게 되다'}},
      {ko:'깨끗하다', ro:'a fi curat', en:'clean', aliases:['sunt curat','ești curat','este curat','suntem curați','sunteți curați','sunt curați','curat','e curat','clean','is clean','are clean'], final:'깨끗해요', forms:{none:'깨끗해요',seq:'깨끗하고',cause1:'깨끗해서',cause2:'깨끗하니까',condition:'깨끗하면',contrast1:'깨끗하지만',contrast2:'깨끗한데',purpose:'깨끗하려고',result:'깨끗해서 그렇게 되다'}},
      {ko:'나쁘다', ro:'a fi rău', en:'bad', aliases:['sunt rău','ești rău','este rău','suntem răi','sunteți răi','sunt răi','rău','e rău','bad','is bad','are bad'], final:'나빠요', forms:{none:'나빠요',seq:'나쁘고',cause1:'나빠서',cause2:'나쁘니까',condition:'나쁘면',contrast1:'나쁘지만',contrast2:'나쁜데',purpose:'나쁘려고',result:'나빠서 그렇게 되다'}},
      {ko:'낮다', ro:'a fi jos', en:'low', aliases:['sunt jos','ești jos','este jos','suntem jos','sunteți jos','jos','e jos','low','is low','are low'], final:'낮아요', forms:{none:'낮아요',seq:'낮고',cause1:'낮아서',cause2:'낮으니까',condition:'낮으면',contrast1:'낮지만',contrast2:'낮은데',purpose:'낮으려고',result:'낮아서 그렇게 되다'}},
      {ko:'낯설다', ro:'a fi necunoscut', en:'to be unfamiliar, strange', aliases:['sunt necunoscut','ești necunoscut','este necunoscut','suntem necunoscuți','sunteți necunoscuți','sunt necunoscuți','necunoscut','e necunoscut','străin','sunt străin','e străin','unfamiliar','is unfamiliar','are unfamiliar','strange','is strange','are strange'], final:'낯설어요', forms:{none:'낯설어요',seq:'낯설고',cause1:'낯설어서',cause2:'낯서니까',condition:'낯서면',contrast1:'낯설지만',contrast2:'낯선데',purpose:'낯서려고',result:'낯설어서 그렇게 되다'}},
      {ko:'내성적이다', ro:'a fi introvertit', en:'to be introverted', aliases:['sunt introvertit','ești introvertit','este introvertit','suntem introvertiți','sunteți introvertiți','sunt introvertiți','introvertit','e introvertit','introverted','is introverted','are introverted'], final:'내성적이에요', forms:{none:'내성적이에요',seq:'내성적이고',cause1:'내성적이에서',cause2:'내성적이니까',condition:'내성적이면',contrast1:'내성적이지만',contrast2:'내성적인데',purpose:'내성적이려고',result:'내성적이에서 그렇게 되다'}},
      {ko:'넓다', ro:'a fi larg', en:'wide', aliases:['sunt larg','ești larg','este larg','suntem largi','sunteți largi','sunt largi','larg','e larg','wide','is wide','are wide'], final:'넓어요', forms:{none:'넓어요',seq:'넓고',cause1:'넓어서',cause2:'넓으니까',condition:'넓으면',contrast1:'넓지만',contrast2:'넓은데',purpose:'넓으려고',result:'넓어서 그렇게 되다'}},
      {ko:'놀랍다', ro:'a fi surprinzător', en:'to be surprising', aliases:['sunt surprinzător','ești surprinzător','este surprinzător','suntem surprinzători','sunteți surprinzători','sunt surprinzători','surprinzător','e surprinzător','surprising','is surprising','are surprising'], final:'놀라워요', forms:{none:'놀라워요',seq:'놀랍고',cause1:'놀라워서',cause2:'놀라우니까',condition:'놀라우면',contrast1:'놀랍지만',contrast2:'놀라운데',purpose:'놀라우려고',result:'놀라워서 그렇게 되다'}},
      {ko:'높다', ro:'a fi înalt', en:'high', aliases:['sunt înalt','ești înalt','este înalt','suntem înalți','sunteți înalți','sunt înalți','înalt','e înalt','high','is high','are high'], final:'높아요', forms:{none:'높아요',seq:'높고',cause1:'높아서',cause2:'높으니까',condition:'높으면',contrast1:'높지만',contrast2:'높은데',purpose:'높으려고',result:'높아서 그렇게 되다'}},
      {ko:'느리다', ro:'a fi lent', en:'slow', aliases:['sunt lent','ești lent','este lent','suntem lenți','sunteți lenți','sunt lenți','lent','e lent','slow','is slow','are slow'], final:'느려요', forms:{none:'느려요',seq:'느리고',cause1:'느려서',cause2:'느리니까',condition:'느리면',contrast1:'느리지만',contrast2:'느린데',purpose:'느리려고',result:'느려서 그렇게 되다'}},
      {ko:'늙다', ro:'a fi bătrân', en:'to be old (age)', aliases:['sunt bătrân','ești bătrân','este bătrân','suntem bătrâni','sunteți bătrâni','sunt bătrâni','bătrân','e bătrân','old','is old','are old'], final:'늙어요', forms:{none:'늙어요',seq:'늙고',cause1:'늙어서',cause2:'늙으니까',condition:'늙으면',contrast1:'늙지만',contrast2:'늙은데',purpose:'늙으려고',result:'늙어서 그렇게 되다'}},
      {ko:'다르다', ro:'a fi diferit', en:'different', aliases:['sunt diferit','ești diferit','este diferit','suntem diferiți','sunteți diferiți','sunt diferiți','diferit','e diferit','different','is different','are different'], final:'달라요', forms:{none:'달라요',seq:'다르고',cause1:'달라서',cause2:'다르니까',condition:'다르면',contrast1:'다르지만',contrast2:'다른데',purpose:'다르려고',result:'달라서 그렇게 되다'}},
      {ko:'다양하다', ro:'a fi divers', en:'to be diverse', aliases:['sunt divers','ești divers','este divers','suntem diverși','sunteți diverși','sunt diverși','divers','e divers','variat','sunt variat','e variat','diverse','is diverse','are diverse'], final:'다양해요', forms:{none:'다양해요',seq:'다양하고',cause1:'다양해서',cause2:'다양하니까',condition:'다양하면',contrast1:'다양하지만',contrast2:'다양한데',purpose:'다양하려고',result:'다양해서 그렇게 되다'}},
      {ko:'다행이다', ro:'a fi norocos', en:'to be fortunate, what a relief', aliases:['sunt norocos','ești norocos','este norocos','suntem norocoși','sunteți norocoși','sunt norocoși','norocos','e norocos','bine că','sunt bine că','e bine că','fortunate','is fortunate','are fortunate','what a relief','is what a relief','are what a relief'], final:'다행이에요', forms:{none:'다행이에요',seq:'다행이고',cause1:'다행이에서',cause2:'다행이니까',condition:'다행이면',contrast1:'다행이지만',contrast2:'다행인데',purpose:'다행이려고',result:'다행이에서 그렇게 되다'}},
      {ko:'단순하다', ro:'a fi simplu', en:'to be simple', aliases:['sunt simplu','ești simplu','este simplu','suntem simpli','sunteți simpli','sunt simpli','simplu','e simplu','simple','is simple','are simple'], final:'단순해요', forms:{none:'단순해요',seq:'단순하고',cause1:'단순해서',cause2:'단순하니까',condition:'단순하면',contrast1:'단순하지만',contrast2:'단순한데',purpose:'단순하려고',result:'단순해서 그렇게 되다'}},
      {ko:'달다', ro:'a fi dulce', en:'to be sweet', aliases:['sunt dulce','ești dulce','este dulce','suntem dulci','sunteți dulci','sunt dulci','dulce','e dulce','sweet','is sweet','are sweet'], final:'달아요', forms:{none:'달아요',seq:'달고',cause1:'달아서',cause2:'다니까',condition:'다면',contrast1:'달지만',contrast2:'단데',purpose:'다려고',result:'달아서 그렇게 되다'}},
      {ko:'답답하다', ro:'a fi apăsător', en:'to feel frustrated / stifled', aliases:['sunt apăsător','ești apăsător','este apăsător','suntem apăsători','sunteți apăsători','sunt apăsători','apăsător','e apăsător','frustrant','sunt frustrant','e frustrant','feel frustrated','is feel frustrated','are feel frustrated','stifled','is stifled','are stifled'], final:'답답해요', forms:{none:'답답해요',seq:'답답하고',cause1:'답답해서',cause2:'답답하니까',condition:'답답하면',contrast1:'답답하지만',contrast2:'답답한데',purpose:'답답하려고',result:'답답해서 그렇게 되다'}},
      {ko:'당황하다', ro:'a fi derutat', en:'to be embarrassed / flustered', aliases:['sunt derutat','ești derutat','este derutat','suntem derutați','sunteți derutați','sunt derutați','derutat','e derutat','stânjenit','sunt stânjenit','e stânjenit','embarrassed','is embarrassed','are embarrassed','flustered','is flustered','are flustered'], final:'당황해요', forms:{none:'당황해요',seq:'당황하고',cause1:'당황해서',cause2:'당황하니까',condition:'당황하면',contrast1:'당황하지만',contrast2:'당황한데',purpose:'당황하려고',result:'당황해서 그렇게 되다'}},
      {ko:'대단하다', ro:'a fi impresionant', en:'to be amazing', aliases:['sunt impresionant','ești impresionant','este impresionant','suntem impresionanți','sunteți impresionanți','sunt impresionanți','impresionant','e impresionant','grozav','sunt grozav','e grozav','amazing','is amazing','are amazing'], final:'대단해요', forms:{none:'대단해요',seq:'대단하고',cause1:'대단해서',cause2:'대단하니까',condition:'대단하면',contrast1:'대단하지만',contrast2:'대단한데',purpose:'대단하려고',result:'대단해서 그렇게 되다'}},
      {ko:'덥다', ro:'a fi cald', en:'to be hot (weather)', aliases:['sunt cald','ești cald','este cald','suntem calzi','sunteți calzi','sunt calzi','cald','e cald','fierbinte','sunt fierbinte','e fierbinte','hot','is hot','are hot'], final:'더워요', forms:{none:'더워요',seq:'덥고',cause1:'더워서',cause2:'더우니까',condition:'더우면',contrast1:'덥지만',contrast2:'더운데',purpose:'더우려고',result:'더워서 그렇게 되다'}},
      {ko:'두껍다', ro:'a fi gros', en:'to be thick', aliases:['sunt gros','ești gros','este gros','suntem groși','sunteți groși','sunt groși','gros','e gros','thick','is thick','are thick'], final:'두꺼워요', forms:{none:'두꺼워요',seq:'두껍고',cause1:'두꺼워서',cause2:'두꺼우니까',condition:'두꺼우면',contrast1:'두껍지만',contrast2:'두꺼운데',purpose:'두꺼우려고',result:'두꺼워서 그렇게 되다'}},
      {ko:'따뜻하다', ro:'a fi cald', en:'warm', aliases:['sunt cald','ești cald','este cald','suntem calzi','sunteți calzi','sunt calzi','cald','e cald','warm','is warm','are warm'], final:'따뜻해요', forms:{none:'따뜻해요',seq:'따뜻하고',cause1:'따뜻해서',cause2:'따뜻하니까',condition:'따뜻하면',contrast1:'따뜻하지만',contrast2:'따뜻한데',purpose:'따뜻하려고',result:'따뜻해서 그렇게 되다'}},
      {ko:'딱딱하다', ro:'a fi tare', en:'to be hard, stiff', aliases:['sunt tare','ești tare','este tare','suntem tari','sunteți tari','sunt tari','tare','e tare','rigid','sunt rigid','e rigid','hard','is hard','are hard','stiff','is stiff','are stiff'], final:'딱딱해요', forms:{none:'딱딱해요',seq:'딱딱하고',cause1:'딱딱해서',cause2:'딱딱하니까',condition:'딱딱하면',contrast1:'딱딱하지만',contrast2:'딱딱한데',purpose:'딱딱하려고',result:'딱딱해서 그렇게 되다'}},
      {ko:'똑똑하다', ro:'a fi deștept', en:'to be smart, intelligent', aliases:['sunt deștept','ești deștept','este deștept','suntem deștepți','sunteți deștepți','sunt deștepți','deștept','e deștept','inteligent','sunt inteligent','e inteligent','smart','is smart','are smart','intelligent','is intelligent','are intelligent'], final:'똑똑해요', forms:{none:'똑똑해요',seq:'똑똑하고',cause1:'똑똑해서',cause2:'똑똑하니까',condition:'똑똑하면',contrast1:'똑똑하지만',contrast2:'똑똑한데',purpose:'똑똑하려고',result:'똑똑해서 그렇게 되다'}},
      {ko:'뜨겁다', ro:'a fi fierbinte', en:'hot', aliases:['sunt fierbinte','ești fierbinte','este fierbinte','suntem fierbinți','sunteți fierbinți','sunt fierbinți','fierbinte','e fierbinte','hot','is hot','are hot'], final:'뜨거워요', forms:{none:'뜨거워요',seq:'뜨겁고',cause1:'뜨거워서',cause2:'뜨거우니까',condition:'뜨거우면',contrast1:'뜨겁지만',contrast2:'뜨거운데',purpose:'뜨거우려고',result:'뜨거워서 그렇게 되다'}},
      {ko:'많다', ro:'a fi mult', en:'a lot', aliases:['sunt mult','ești mult','este mult','suntem mulți','sunteți mulți','sunt mulți','mult','e mult','a lot','is a lot','are a lot'], final:'많아요', forms:{none:'많아요',seq:'많고',cause1:'많아서',cause2:'많으니까',condition:'많으면',contrast1:'많지만',contrast2:'많은데',purpose:'많으려고',result:'많아서 그렇게 되다'}},
      ...
      {ko:'맛있다', ro:'a fi delicios', en:'delicious', aliases:['sunt delicios','ești delicios','este delicios','suntem delicioși','sunteți delicioși','sunt delicioși','delicios','e delicios','delicious','is delicious','are delicious'], final:'맛있어요', forms:{none:'맛있어요',seq:'맛있고',cause1:'맛있어서',cause2:'맛있으니까',condition:'맛있으면',contrast1:'맛있지만',contrast2:'맛있는데',purpose:'맛있으려고',result:'맛있어서 그렇게 되다'}},
      {ko:'맞다', ro:'a fi corect', en:'to be correct, to fit', aliases:['sunt corect','ești corect','este corect','suntem corecți','sunteți corecți','sunt corecți','corect','e corect','se potrivi','sunt se potrivi','e se potrivi','correct','is correct','are correct','fit','is fit','are fit'], final:'맞아요', forms:{none:'맞아요',seq:'맞고',cause1:'맞아서',cause2:'맞으니까',condition:'맞으면',contrast1:'맞지만',contrast2:'맞은데',purpose:'맞으려고',result:'맞아서 그렇게 되다'}},
      {ko:'맵다', ro:'a fi iute', en:'to be spicy', aliases:['sunt iute','ești iute','este iute','suntem iuți','sunteți iuți','sunt iuți','iute','e iute','picant','sunt picant','e picant','spicy','is spicy','are spicy'], final:'매워요', forms:{none:'매워요',seq:'맵고',cause1:'매워서',cause2:'매우니까',condition:'매우면',contrast1:'맵지만',contrast2:'매운데',purpose:'매우려고',result:'매워서 그렇게 되다'}},
      ...
      {ko:'멋있다', ro:'a fi arătos', en:'to be cool, handsome', aliases:['sunt arătos','ești arătos','este arătos','suntem arătoși','sunteți arătoși','sunt arătoși','arătos','e arătos','mișto','sunt mișto','e mișto','cool','is cool','are cool','handsome','is handsome','are handsome'], final:'멋있어요', forms:{none:'멋있어요',seq:'멋있고',cause1:'멋있어서',cause2:'멋있으니까',condition:'멋있으면',contrast1:'멋있지만',contrast2:'멋있는데',purpose:'멋있으려고',result:'멋있어서 그렇게 되다'}},
      {ko:'목마르다', ro:'a fi însetat', en:'to be thirsty', aliases:['sunt însetat','ești însetat','este însetat','suntem însetați','sunteți însetați','sunt însetați','însetat','e însetat','thirsty','is thirsty','are thirsty'], final:'목말라요', forms:{none:'목말라요',seq:'목마르고',cause1:'목말라서',cause2:'목마르니까',condition:'목마르면',contrast1:'목마르지만',contrast2:'목마른데',purpose:'목마르려고',result:'목말라서 그렇게 되다'}},
      {ko:'무겁다', ro:'a fi greu', en:'to be heavy', aliases:['sunt greu','ești greu','este greu','suntem grei','sunteți grei','sunt grei','greu','e greu','grelos','sunt grelos','e grelos','heavy','is heavy','are heavy'], final:'무거워요', forms:{none:'무거워요',seq:'무겁고',cause1:'무거워서',cause2:'무거우니까',condition:'무거우면',contrast1:'무겁지만',contrast2:'무거운데',purpose:'무거우려고',result:'무거워서 그렇게 되다'}},
      {ko:'무섭다', ro:'a fi înfricoșător', en:'to be scary/frightening', aliases:['sunt înfricoșător','ești înfricoșător','este înfricoșător','suntem înfricoșători','sunteți înfricoșători','sunt înfricoșători','înfricoșător','e înfricoșător','scary','is scary','are scary','frightening','is frightening','are frightening'], final:'무서워요', forms:{none:'무서워요',seq:'무섭고',cause1:'무서워서',cause2:'무서우니까',condition:'무서우면',contrast1:'무섭지만',contrast2:'무서운데',purpose:'무서우려고',result:'무서워서 그렇게 되다'}},
      {ko:'문화적이다', ro:'a fi cultural', en:'cultural', aliases:['sunt cultural','ești cultural','este cultural','suntem culturali','sunteți culturali','sunt culturali','cultural','e cultural','is cultural','are cultural'], final:'문화적이에요', forms:{none:'문화적이에요',seq:'문화적이고',cause1:'문화적이에서',cause2:'문화적이니까',condition:'문화적이면',contrast1:'문화적이지만',contrast2:'문화적인데',purpose:'문화적이려고',result:'문화적이에서 그렇게 되다'}},
      {ko:'미끄럽다', ro:'a fi alunecos', en:'slippery', aliases:['sunt alunecos','ești alunecos','este alunecos','suntem alunecoși','sunteți alunecoși','sunt alunecoși','alunecos','e alunecos','slippery','is slippery','are slippery'], final:'미끄러워요', forms:{none:'미끄러워요',seq:'미끄럽고',cause1:'미끄러워서',cause2:'미끄러우니까',condition:'미끄러우면',contrast1:'미끄럽지만',contrast2:'미끄러운데',purpose:'미끄러우려고',result:'미끄러워서 그렇게 되다'}},
      ...
      {ko:'바쁘다', ro:'a fi ocupat', en:'busy', aliases:['sunt ocupat','ești ocupat','este ocupat','suntem ocupați','sunteți ocupați','sunt ocupați','ocupat','e ocupat','busy','is busy','are busy'], final:'바빠요', forms:{none:'바빠요',seq:'바쁘고',cause1:'바빠서',cause2:'바쁘니까',condition:'바쁘면',contrast1:'바쁘지만',contrast2:'바쁜데',purpose:'바쁘려고',result:'바빠서 그렇게 되다'}},
      {ko:'반갑다', ro:'a fi bucuros', en:'to be glad (to meet)', aliases:['sunt bucuros','ești bucuros','este bucuros','suntem bucuroși','sunteți bucuroși','sunt bucuroși','bucuros','e bucuros','glad','is glad','are glad'], final:'반가워요', forms:{none:'반가워요',seq:'반갑고',cause1:'반가워서',cause2:'반가우니까',condition:'반가우면',contrast1:'반갑지만',contrast2:'반가운데',purpose:'반가우려고',result:'반가워서 그렇게 되다'}},
      {ko:'밝다', ro:'a fi luminos', en:'bright', aliases:['sunt luminos','ești luminos','este luminos','suntem luminoși','sunteți luminoși','sunt luminoși','luminos','e luminos','bright','is bright','are bright'], final:'밝아요', forms:{none:'밝아요',seq:'밝고',cause1:'밝아서',cause2:'밝으니까',condition:'밝으면',contrast1:'밝지만',contrast2:'밝은데',purpose:'밝으려고',result:'밝아서 그렇게 되다'}},
      {ko:'배부르다', ro:'a fi sătul', en:'to be full (after eating)', aliases:['sunt sătul','ești sătul','este sătul','suntem sătui','sunteți sătui','sunt sătui','sătul','e sătul','full','is full','are full'], final:'배불러요', forms:{none:'배불러요',seq:'배부르고',cause1:'배불러서',cause2:'배부르니까',condition:'배부르면',contrast1:'배부르지만',contrast2:'배부른데',purpose:'배부르려고',result:'배불러서 그렇게 되다'}},
      {ko:'복잡하다', ro:'a fi complex', en:'complex', aliases:['sunt complex','ești complex','este complex','suntem complexi','sunteți complexi','sunt complexi','complex','e complex','is complex','are complex'], final:'복잡해요', forms:{none:'복잡해요',seq:'복잡하고',cause1:'복잡해서',cause2:'복잡하니까',condition:'복잡하면',contrast1:'복잡하지만',contrast2:'복잡한데',purpose:'복잡하려고',result:'복잡해서 그렇게 되다'}},
      {ko:'부끄럽다', ro:'a fi timid', en:'to be shy, ashamed', aliases:['sunt timid','ești timid','este timid','suntem timizi','sunteți timizi','sunt timizi','timid','e timid','rușinat','sunt rușinat','e rușinat','shy','is shy','are shy','ashamed','is ashamed','are ashamed'], final:'부끄러워요', forms:{none:'부끄러워요',seq:'부끄럽고',cause1:'부끄러워서',cause2:'부끄러우니까',condition:'부끄러우면',contrast1:'부끄럽지만',contrast2:'부끄러운데',purpose:'부끄러우려고',result:'부끄러워서 그렇게 되다'}},
      {ko:'부드럽다', ro:'a fi moale', en:'to be soft, smooth', aliases:['sunt moale','ești moale','este moale','suntem moi','sunteți moi','sunt moi','moale','e moale','lin','sunt lin','e lin','soft','is soft','are soft','smooth','is smooth','are smooth'], final:'부드러워요', forms:{none:'부드러워요',seq:'부드럽고',cause1:'부드러워서',cause2:'부드러우니까',condition:'부드러우면',contrast1:'부드럽지만',contrast2:'부드러운데',purpose:'부드러우려고',result:'부드러워서 그렇게 되다'}},
      {ko:'부럽다', ro:'a fi invidios', en:'to be envious', aliases:['sunt invidios','ești invidios','este invidios','suntem invidioși','sunteți invidioși','sunt invidioși','invidios','e invidios','envious','is envious','are envious'], final:'부러워요', forms:{none:'부러워요',seq:'부럽고',cause1:'부러워서',cause2:'부러우니까',condition:'부러우면',contrast1:'부럽지만',contrast2:'부러운데',purpose:'부러우려고',result:'부러워서 그렇게 되다'}},
      {ko:'부족하다', ro:'a fi insuficient', en:'to be insufficient, lacking', aliases:['sunt insuficient','ești insuficient','este insuficient','suntem insuficienți','sunteți insuficienți','sunt insuficienți','insuficient','e insuficient','insufficient','is insufficient','are insufficient','lacking','is lacking','are lacking'], final:'부족해요', forms:{none:'부족해요',seq:'부족하고',cause1:'부족해서',cause2:'부족하니까',condition:'부족하면',contrast1:'부족하지만',contrast2:'부족한데',purpose:'부족하려고',result:'부족해서 그렇게 되다'}},
      {ko:'분명하다', ro:'a fi clar', en:'clear', aliases:['sunt clar','ești clar','este clar','suntem clari','sunteți clari','sunt clari','clar','e clar','clear','is clear','are clear'], final:'분명해요', forms:{none:'분명해요',seq:'분명하고',cause1:'분명해서',cause2:'분명하니까',condition:'분명하면',contrast1:'분명하지만',contrast2:'분명한데',purpose:'분명하려고',result:'분명해서 그렇게 되다'}},
      {ko:'불안하다', ro:'a fi neliniștit', en:'to be anxious / uneasy', aliases:['sunt neliniștit','ești neliniștit','este neliniștit','suntem neliniștiți','sunteți neliniștiți','sunt neliniștiți','neliniștit','e neliniștit','anxios','sunt anxios','e anxios','anxious','is anxious','are anxious','uneasy','is uneasy','are uneasy'], final:'불안해요', forms:{none:'불안해요',seq:'불안하고',cause1:'불안해서',cause2:'불안하니까',condition:'불안하면',contrast1:'불안하지만',contrast2:'불안한데',purpose:'불안하려고',result:'불안해서 그렇게 되다'}},
      {ko:'불편하다', ro:'a fi incomod', en:'to be uncomfortable', aliases:['sunt incomod','ești incomod','este incomod','suntem incomozi','sunteți incomozi','sunt incomozi','incomod','e incomod','neplăcut','sunt neplăcut','e neplăcut','uncomfortable','is uncomfortable','are uncomfortable'], final:'불편해요', forms:{none:'불편해요',seq:'불편하고',cause1:'불편해서',cause2:'불편하니까',condition:'불편하면',contrast1:'불편하지만',contrast2:'불편한데',purpose:'불편하려고',result:'불편해서 그렇게 되다'}},
      {ko:'비슷하다', ro:'a fi similar', en:'similar', aliases:['sunt similar','ești similar','este similar','suntem similari','sunteți similari','sunt similari','similar','e similar','is similar','are similar'], final:'비슷해요', forms:{none:'비슷해요',seq:'비슷하고',cause1:'비슷해서',cause2:'비슷하니까',condition:'비슷하면',contrast1:'비슷하지만',contrast2:'비슷한데',purpose:'비슷하려고',result:'비슷해서 그렇게 되다'}},
      {ko:'비싸다', ro:'a fi scump', en:'expensive', aliases:['sunt scump','ești scump','este scump','suntem scumpi','sunteți scumpi','sunt scumpi','scump','e scump','expensive','is expensive','are expensive'], final:'비싸요', forms:{none:'비싸요',seq:'비싸고',cause1:'비싸서',cause2:'비싸니까',condition:'비싸면',contrast1:'비싸지만',contrast2:'비싼데',purpose:'비싸려고',result:'비싸서 그렇게 되다'}},
      {ko:'빠르다', ro:'a fi rapid', en:'fast', aliases:['sunt rapid','ești rapid','este rapid','suntem rapizi','sunteți rapizi','sunt rapizi','rapid','e rapid','fast','is fast','are fast'], final:'빨라요', forms:{none:'빨라요',seq:'빠르고',cause1:'빨라서',cause2:'빠르니까',condition:'빠르면',contrast1:'빠르지만',contrast2:'빠른데',purpose:'빠르려고',result:'빨라서 그렇게 되다'}},
      ...
      {ko:'사회적이다', ro:'a fi social', en:'social', aliases:['sunt social','ești social','este social','suntem sociali','sunteți sociali','sunt sociali','social','e social','is social','are social'], final:'사회적이에요', forms:{none:'사회적이에요',seq:'사회적이고',cause1:'사회적이에서',cause2:'사회적이니까',condition:'사회적이면',contrast1:'사회적이지만',contrast2:'사회적인데',purpose:'사회적이려고',result:'사회적이에서 그렇게 되다'}},
      {ko:'상쾌하다', ro:'a fi răcoritor', en:'to be refreshing', aliases:['sunt răcoritor','ești răcoritor','este răcoritor','suntem răcoritori','sunteți răcoritori','sunt răcoritori','răcoritor','e răcoritor','revigorant','sunt revigorant','e revigorant','refreshing','is refreshing','are refreshing'], final:'상쾌해요', forms:{none:'상쾌해요',seq:'상쾌하고',cause1:'상쾌해서',cause2:'상쾌하니까',condition:'상쾌하면',contrast1:'상쾌하지만',contrast2:'상쾌한데',purpose:'상쾌하려고',result:'상쾌해서 그렇게 되다'}},
      {ko:'새롭다', ro:'a fi nou', en:'new', aliases:['sunt nou','ești nou','este nou','suntem noi','sunteți noi','sunt noi','nou','e nou','new','is new','are new'], final:'새로워요', forms:{none:'새로워요',seq:'새롭고',cause1:'새로워서',cause2:'새로우니까',condition:'새로우면',contrast1:'새롭지만',contrast2:'새로운데',purpose:'새로우려고',result:'새로워서 그렇게 되다'}},
      {ko:'서운하다', ro:'a fi dezamăgit', en:'to feel hurt / disappointed', aliases:['sunt dezamăgit','ești dezamăgit','este dezamăgit','suntem dezamăgiți','sunteți dezamăgiți','sunt dezamăgiți','dezamăgit','e dezamăgit','mâhnit','sunt mâhnit','e mâhnit','feel hurt','is feel hurt','are feel hurt','disappointed','is disappointed','are disappointed'], final:'서운해요', forms:{none:'서운해요',seq:'서운하고',cause1:'서운해서',cause2:'서운하니까',condition:'서운하면',contrast1:'서운하지만',contrast2:'서운한데',purpose:'서운하려고',result:'서운해서 그렇게 되다'}},
      {ko:'성실하다', ro:'a fi harnic', en:'to be diligent, sincere', aliases:['sunt harnic','ești harnic','este harnic','suntem harnici','sunteți harnici','sunt harnici','harnic','e harnic','conștiincios','sunt conștiincios','e conștiincios','diligent','is diligent','are diligent','sincere','is sincere','are sincere'], final:'성실해요', forms:{none:'성실해요',seq:'성실하고',cause1:'성실해서',cause2:'성실하니까',condition:'성실하면',contrast1:'성실하지만',contrast2:'성실한데',purpose:'성실하려고',result:'성실해서 그렇게 되다'}},
      {ko:'소극적이다', ro:'a fi pasiv', en:'to be passive / reserved', aliases:['sunt pasiv','ești pasiv','este pasiv','suntem pasivi','sunteți pasivi','sunt pasivi','pasiv','e pasiv','rezervat','sunt rezervat','e rezervat','passive','is passive','are passive','reserved','is reserved','are reserved'], final:'소극적이에요', forms:{none:'소극적이에요',seq:'소극적이고',cause1:'소극적이에서',cause2:'소극적이니까',condition:'소극적이면',contrast1:'소극적이지만',contrast2:'소극적인데',purpose:'소극적이려고',result:'소극적이에서 그렇게 되다'}},
      {ko:'소중하다', ro:'a fi prețios', en:'to be precious, valuable', aliases:['sunt prețios','ești prețios','este prețios','suntem prețioși','sunteți prețioși','sunt prețioși','prețios','e prețios','drag','sunt drag','e drag','precious','is precious','are precious','valuable','is valuable','are valuable'], final:'소중해요', forms:{none:'소중해요',seq:'소중하고',cause1:'소중해서',cause2:'소중하니까',condition:'소중하면',contrast1:'소중하지만',contrast2:'소중한데',purpose:'소중하려고',result:'소중해서 그렇게 되다'}},
      {ko:'쉽다', ro:'a fi ușor', en:'easy', aliases:['sunt ușor','ești ușor','este ușor','suntem ușori','sunteți ușori','sunt ușori','ușor','e ușor','easy','is easy','are easy'], final:'쉬워요', forms:{none:'쉬워요',seq:'쉽고',cause1:'쉬워서',cause2:'쉬우니까',condition:'쉬우면',contrast1:'쉽지만',contrast2:'쉬운데',purpose:'쉬우려고',result:'쉬워서 그렇게 되다'}},
      {ko:'시끄럽다', ro:'a fi zgomotos', en:'to be noisy, loud', aliases:['sunt zgomotos','ești zgomotos','este zgomotos','suntem zgomotoși','sunteți zgomotoși','sunt zgomotoși','zgomotos','e zgomotos','noisy','is noisy','are noisy','loud','is loud','are loud'], final:'시끄러워요', forms:{none:'시끄러워요',seq:'시끄럽고',cause1:'시끄러워서',cause2:'시끄러우니까',condition:'시끄러우면',contrast1:'시끄럽지만',contrast2:'시끄러운데',purpose:'시끄러우려고',result:'시끄러워서 그렇게 되다'}},
      {ko:'시다', ro:'a fi acru', en:'to be sour', aliases:['sunt acru','ești acru','este acru','suntem acri','sunteți acri','sunt acri','acru','e acru','sour','is sour','are sour'], final:'셔요', forms:{none:'셔요',seq:'시고',cause1:'셔서',cause2:'시니까',condition:'시면',contrast1:'시지만',contrast2:'신데',purpose:'시려고',result:'셔서 그렇게 되다'}},
      {ko:'시원하다', ro:'a fi răcoros', en:'refreshing', aliases:['sunt răcoros','ești răcoros','este răcoros','suntem răcoroși','sunteți răcoroși','sunt răcoroși','răcoros','e răcoros','refreshing','is refreshing','are refreshing'], final:'시원해요', forms:{none:'시원해요',seq:'시원하고',cause1:'시원해서',cause2:'시원하니까',condition:'시원하면',contrast1:'시원하지만',contrast2:'시원한데',purpose:'시원하려고',result:'시원해서 그렇게 되다'}},
      {ko:'신기하다', ro:'a fi uimitor', en:'to be amazing, fascinating', aliases:['sunt uimitor','ești uimitor','este uimitor','suntem uimitori','sunteți uimitori','sunt uimitori','uimitor','e uimitor','fascinant','sunt fascinant','e fascinant','amazing','is amazing','are amazing','fascinating','is fascinating','are fascinating'], final:'신기해요', forms:{none:'신기해요',seq:'신기하고',cause1:'신기해서',cause2:'신기하니까',condition:'신기하면',contrast1:'신기하지만',contrast2:'신기한데',purpose:'신기하려고',result:'신기해서 그렇게 되다'}},
      {ko:'심각하다', ro:'a fi grav', en:'to be serious', aliases:['sunt grav','ești grav','este grav','suntem gravi','sunteți gravi','sunt gravi','grav','e grav','serios','sunt serios','e serios','serious','is serious','are serious'], final:'심각해요', forms:{none:'심각해요',seq:'심각하고',cause1:'심각해서',cause2:'심각하니까',condition:'심각하면',contrast1:'심각하지만',contrast2:'심각한데',purpose:'심각하려고',result:'심각해서 그렇게 되다'}},
      {ko:'심심하다', ro:'a fi plictisit', en:'to be bored', aliases:['sunt plictisit','ești plictisit','este plictisit','suntem plictisiți','sunteți plictisiți','sunt plictisiți','plictisit','e plictisit','bored','is bored','are bored'], final:'심심해요', forms:{none:'심심해요',seq:'심심하고',cause1:'심심해서',cause2:'심심하니까',condition:'심심하면',contrast1:'심심하지만',contrast2:'심심한데',purpose:'심심하려고',result:'심심해서 그렇게 되다'}},
      {ko:'싱겁다', ro:'a fi fad', en:'to be bland', aliases:['sunt fad','ești fad','este fad','suntem fazi','sunteți fazi','sunt fazi','fad','e fad','nesărat','sunt nesărat','e nesărat','bland','is bland','are bland'], final:'싱거워요', forms:{none:'싱거워요',seq:'싱겁고',cause1:'싱거워서',cause2:'싱거우니까',condition:'싱거우면',contrast1:'싱겁지만',contrast2:'싱거운데',purpose:'싱거우려고',result:'싱거워서 그렇게 되다'}},
      {ko:'싸다', ro:'a fi ieftin', en:'cheap', aliases:['sunt ieftin','ești ieftin','este ieftin','suntem ieftini','sunteți ieftini','sunt ieftini','ieftin','e ieftin','cheap','is cheap','are cheap'], final:'싸요', forms:{none:'싸요',seq:'싸고',cause1:'싸서',cause2:'싸니까',condition:'싸면',contrast1:'싸지만',contrast2:'싼데',purpose:'싸려고',result:'싸서 그렇게 되다'}},
      ...
      {ko:'아프다', ro:'a fi bolnav', en:'to be sick, to hurt', aliases:['sunt bolnav','ești bolnav','este bolnav','suntem bolnavi','sunteți bolnavi','sunt bolnavi','bolnav','e bolnav','durea','sunt durea','e durea','sick','is sick','are sick','hurt','is hurt','are hurt'], final:'아파요', forms:{none:'아파요',seq:'아프고',cause1:'아파서',cause2:'아프니까',condition:'아프면',contrast1:'아프지만',contrast2:'아픈데',purpose:'아프려고',result:'아파서 그렇게 되다'}},
      {ko:'안전하다', ro:'a fi sigur', en:'safe', aliases:['sunt sigur','ești sigur','este sigur','suntem siguri','sunteți siguri','sunt siguri','sigur','e sigur','safe','is safe','are safe'], final:'안전해요', forms:{none:'안전해요',seq:'안전하고',cause1:'안전해서',cause2:'안전하니까',condition:'안전하면',contrast1:'안전하지만',contrast2:'안전한데',purpose:'안전하려고',result:'안전해서 그렇게 되다'}},
      {ko:'약하다', ro:'a fi slab', en:'weak', aliases:['sunt slab','ești slab','este slab','suntem slabi','sunteți slabi','sunt slabi','slab','e slab','weak','is weak','are weak'], final:'약해요', forms:{none:'약해요',seq:'약하고',cause1:'약해서',cause2:'약하니까',condition:'약하면',contrast1:'약하지만',contrast2:'약한데',purpose:'약하려고',result:'약해서 그렇게 되다'}},
      {ko:'얇다', ro:'a fi subțire', en:'to be thin', aliases:['sunt subțire','ești subțire','este subțire','suntem subțiri','sunteți subțiri','sunt subțiri','subțire','e subțire','thin','is thin','are thin'], final:'얇어요', forms:{none:'얇어요',seq:'얇고',cause1:'얇어서',cause2:'얇으니까',condition:'얇으면',contrast1:'얇지만',contrast2:'얇은데',purpose:'얇으려고',result:'얇어서 그렇게 되다'}},
      {ko:'얕다', ro:'a fi superficial', en:'shallow', aliases:['sunt superficial','ești superficial','este superficial','suntem superficiali','sunteți superficiali','sunt superficiali','superficial','e superficial','shallow','is shallow','are shallow'], final:'얕어요', forms:{none:'얕어요',seq:'얕고',cause1:'얕어서',cause2:'얕으니까',condition:'얕으면',contrast1:'얕지만',contrast2:'얕은데',purpose:'얕으려고',result:'얕어서 그렇게 되다'}},
      {ko:'어둡다', ro:'a fi întunecat', en:'dark', aliases:['sunt întunecat','ești întunecat','este întunecat','suntem întunecați','sunteți întunecați','sunt întunecați','întunecat','e întunecat','dark','is dark','are dark'], final:'어두워요', forms:{none:'어두워요',seq:'어둡고',cause1:'어두워서',cause2:'어두우니까',condition:'어두우면',contrast1:'어둡지만',contrast2:'어두운데',purpose:'어두우려고',result:'어두워서 그렇게 되다'}},
      {ko:'어렵다', ro:'a fi dificil', en:'difficult', aliases:['sunt dificil','ești dificil','este dificil','suntem dificili','sunteți dificili','sunt dificili','dificil','e dificil','difficult','is difficult','are difficult'], final:'어려워요', forms:{none:'어려워요',seq:'어렵고',cause1:'어려워서',cause2:'어려우니까',condition:'어려우면',contrast1:'어렵지만',contrast2:'어려운데',purpose:'어려우려고',result:'어려워서 그렇게 되다'}},
      {ko:'억울하다', ro:'a fi nedreptățit', en:'to feel wronged', aliases:['sunt nedreptățit','ești nedreptățit','este nedreptățit','suntem nedreptățiți','sunteți nedreptățiți','sunt nedreptățiți','nedreptățit','e nedreptățit','feel wronged','is feel wronged','are feel wronged'], final:'억울해요', forms:{none:'억울해요',seq:'억울하고',cause1:'억울해서',cause2:'억울하니까',condition:'억울하면',contrast1:'억울하지만',contrast2:'억울한데',purpose:'억울하려고',result:'억울해서 그렇게 되다'}},
      {ko:'예민하다', ro:'a fi sensibil', en:'to be sensitive', aliases:['sunt sensibil','ești sensibil','este sensibil','suntem sensibili','sunteți sensibili','sunt sensibili','sensibil','e sensibil','sensitive','is sensitive','are sensitive'], final:'예민해요', forms:{none:'예민해요',seq:'예민하고',cause1:'예민해서',cause2:'예민하니까',condition:'예민하면',contrast1:'예민하지만',contrast2:'예민한데',purpose:'예민하려고',result:'예민해서 그렇게 되다'}},
      {ko:'예쁘다', ro:'a fi frumos', en:'pretty', aliases:['sunt frumos','ești frumos','este frumos','suntem frumoși','sunteți frumoși','sunt frumoși','frumos','e frumos','pretty','is pretty','are pretty'], final:'예뻐요', forms:{none:'예뻐요',seq:'예쁘고',cause1:'예뻐서',cause2:'예쁘니까',condition:'예쁘면',contrast1:'예쁘지만',contrast2:'예쁜데',purpose:'예쁘려고',result:'예뻐서 그렇게 되다'}},
      {ko:'완벽하다', ro:'a fi perfect', en:'to be perfect', aliases:['sunt perfect','ești perfect','este perfect','suntem perfecți','sunteți perfecți','sunt perfecți','perfect','e perfect','is perfect','are perfect'], final:'완벽해요', forms:{none:'완벽해요',seq:'완벽하고',cause1:'완벽해서',cause2:'완벽하니까',condition:'완벽하면',contrast1:'완벽하지만',contrast2:'완벽한데',purpose:'완벽하려고',result:'완벽해서 그렇게 되다'}},
      {ko:'외롭다', ro:'a fi singur', en:'to be lonely', aliases:['sunt singur','ești singur','este singur','suntem singuri','sunteți singuri','sunt singuri','singur','e singur','singuratic','sunt singuratic','e singuratic','lonely','is lonely','are lonely'], final:'외로워요', forms:{none:'외로워요',seq:'외롭고',cause1:'외로워서',cause2:'외로우니까',condition:'외로우면',contrast1:'외롭지만',contrast2:'외로운데',purpose:'외로우려고',result:'외로워서 그렇게 되다'}},
      {ko:'우울하다', ro:'a fi deprimat', en:'to be depressed', aliases:['sunt deprimat','ești deprimat','este deprimat','suntem deprimați','sunteți deprimați','sunt deprimați','deprimat','e deprimat','depressed','is depressed','are depressed'], final:'우울해요', forms:{none:'우울해요',seq:'우울하고',cause1:'우울해서',cause2:'우울하니까',condition:'우울하면',contrast1:'우울하지만',contrast2:'우울한데',purpose:'우울하려고',result:'우울해서 그렇게 되다'}},
      {ko:'위험하다', ro:'a fi periculos', en:'dangerous', aliases:['sunt periculos','ești periculos','este periculos','suntem periculoși','sunteți periculoși','sunt periculoși','periculos','e periculos','dangerous','is dangerous','are dangerous'], final:'위험해요', forms:{none:'위험해요',seq:'위험하고',cause1:'위험해서',cause2:'위험하니까',condition:'위험하면',contrast1:'위험하지만',contrast2:'위험한데',purpose:'위험하려고',result:'위험해서 그렇게 되다'}},
      {ko:'유명하다', ro:'a fi faimos', en:'famous', aliases:['sunt faimos','ești faimos','este faimos','suntem faimoși','sunteți faimoși','sunt faimoși','faimos','e faimos','famous','is famous','are famous'], final:'유명해요', forms:{none:'유명해요',seq:'유명하고',cause1:'유명해서',cause2:'유명하니까',condition:'유명하면',contrast1:'유명하지만',contrast2:'유명한데',purpose:'유명하려고',result:'유명해서 그렇게 되다'}},
      {ko:'이상하다', ro:'a fi ciudat', en:'to be strange, weird', aliases:['sunt ciudat','ești ciudat','este ciudat','suntem ciudați','sunteți ciudați','sunt ciudați','ciudat','e ciudat','strange','is strange','are strange','weird','is weird','are weird'], final:'이상해요', forms:{none:'이상해요',seq:'이상하고',cause1:'이상해서',cause2:'이상하니까',condition:'이상하면',contrast1:'이상하지만',contrast2:'이상한데',purpose:'이상하려고',result:'이상해서 그렇게 되다'}},
      ...
      {ko:'자연스럽다', ro:'a fi natural', en:'to be natural', aliases:['sunt natural','ești natural','este natural','suntem naturali','sunteți naturali','sunt naturali','natural','e natural','is natural','are natural'], final:'자연스러워요', forms:{none:'자연스러워요',seq:'자연스럽고',cause1:'자연스러워서',cause2:'자연스러우니까',condition:'자연스러우면',contrast1:'자연스럽지만',contrast2:'자연스러운데',purpose:'자연스러우려고',result:'자연스러워서 그렇게 되다'}},
      {ko:'작다', ro:'a fi mic', en:'small', aliases:['sunt mic','ești mic','este mic','suntem mici','sunteți mici','sunt mici','mic','e mic','small','is small','are small'], final:'작아요', forms:{none:'작아요',seq:'작고',cause1:'작아서',cause2:'작으니까',condition:'작으면',contrast1:'작지만',contrast2:'작은데',purpose:'작으려고',result:'작아서 그렇게 되다'}},
      {ko:'재미없다', ro:'a fi plictisitor', en:'to be boring', aliases:['sunt plictisitor','ești plictisitor','este plictisitor','suntem plictisitori','sunteți plictisitori','sunt plictisitori','plictisitor','e plictisitor','boring','is boring','are boring'], final:'재미없어요', forms:{none:'재미없어요',seq:'재미없고',cause1:'재미없어서',cause2:'재미없으니까',condition:'재미없으면',contrast1:'재미없지만',contrast2:'재미없는데',purpose:'재미없으려고',result:'재미없어서 그렇게 되다'}},
      {ko:'재미있다', ro:'a fi interesant', en:'interesting', aliases:['sunt interesant','ești interesant','este interesant','suntem interesanți','sunteți interesanți','sunt interesanți','interesant','e interesant','interesting','is interesting','are interesting'], final:'재미있어요', forms:{none:'재미있어요',seq:'재미있고',cause1:'재미있어서',cause2:'재미있으니까',condition:'재미있으면',contrast1:'재미있지만',contrast2:'재미있는데',purpose:'재미있으려고',result:'재미있어서 그렇게 되다'}},
      {ko:'적극적이다', ro:'a fi activ', en:'to be proactive', aliases:['sunt activ','ești activ','este activ','suntem activi','sunteți activi','sunt activi','activ','e activ','proactiv','sunt proactiv','e proactiv','proactive','is proactive','are proactive'], final:'적극적이에요', forms:{none:'적극적이에요',seq:'적극적이고',cause1:'적극적이에서',cause2:'적극적이니까',condition:'적극적이면',contrast1:'적극적이지만',contrast2:'적극적인데',purpose:'적극적이려고',result:'적극적이에서 그렇게 되다'}},
      {ko:'적다', ro:'a fi puțin', en:'little', aliases:['sunt puțin','ești puțin','este puțin','suntem puțini','sunteți puțini','sunt puțini','puțin','e puțin','little','is little','are little'], final:'적어요', forms:{none:'적어요',seq:'적고',cause1:'적어서',cause2:'적으니까',condition:'적으면',contrast1:'적지만',contrast2:'적은데',purpose:'적으려고',result:'적어서 그렇게 되다'}},
      {ko:'전문적이다', ro:'a fi profesional', en:'professional', aliases:['sunt profesional','ești profesional','este profesional','suntem profesionali','sunteți profesionali','sunt profesionali','profesional','e profesional','professional','is professional','are professional'], final:'전문적이에요', forms:{none:'전문적이에요',seq:'전문적이고',cause1:'전문적이에서',cause2:'전문적이니까',condition:'전문적이면',contrast1:'전문적이지만',contrast2:'전문적인데',purpose:'전문적이려고',result:'전문적이에서 그렇게 되다'}},
      {ko:'전통적이다', ro:'a fi tradițional', en:'traditional', aliases:['sunt tradițional','ești tradițional','este tradițional','suntem tradiționali','sunteți tradiționali','sunt tradiționali','tradițional','e tradițional','traditional','is traditional','are traditional'], final:'전통적이에요', forms:{none:'전통적이에요',seq:'전통적이고',cause1:'전통적이에서',cause2:'전통적이니까',condition:'전통적이면',contrast1:'전통적이지만',contrast2:'전통적인데',purpose:'전통적이려고',result:'전통적이에서 그렇게 되다'}},
      {ko:'젊다', ro:'a fi tânăr', en:'to be young', aliases:['sunt tânăr','ești tânăr','este tânăr','suntem tânări','sunteți tânări','sunt tânări','tânăr','e tânăr','young','is young','are young'], final:'젊어요', forms:{none:'젊어요',seq:'젊고',cause1:'젊어서',cause2:'젊으니까',condition:'젊으면',contrast1:'젊지만',contrast2:'젊은데',purpose:'젊으려고',result:'젊어서 그렇게 되다'}},
      {ko:'정치적이다', ro:'a fi politic', en:'political', aliases:['sunt politic','ești politic','este politic','suntem politici','sunteți politici','sunt politici','politic','e politic','political','is political','are political'], final:'정치적이에요', forms:{none:'정치적이에요',seq:'정치적이고',cause1:'정치적이에서',cause2:'정치적이니까',condition:'정치적이면',contrast1:'정치적이지만',contrast2:'정치적인데',purpose:'정치적이려고',result:'정치적이에서 그렇게 되다'}},
      {ko:'정확하다', ro:'a fi exact', en:'to be accurate', aliases:['sunt exact','ești exact','este exact','suntem exacți','sunteți exacți','sunt exacți','exact','e exact','precis','sunt precis','e precis','accurate','is accurate','are accurate'], final:'정확해요', forms:{none:'정확해요',seq:'정확하고',cause1:'정확해서',cause2:'정확하니까',condition:'정확하면',contrast1:'정확하지만',contrast2:'정확한데',purpose:'정확하려고',result:'정확해서 그렇게 되다'}},
      {ko:'조용하다', ro:'a fi liniștit', en:'quiet', aliases:['sunt liniștit','ești liniștit','este liniștit','suntem liniștiți','sunteți liniștiți','sunt liniștiți','liniștit','e liniștit','quiet','is quiet','are quiet'], final:'조용해요', forms:{none:'조용해요',seq:'조용하고',cause1:'조용해서',cause2:'조용하니까',condition:'조용하면',contrast1:'조용하지만',contrast2:'조용한데',purpose:'조용하려고',result:'조용해서 그렇게 되다'}},
      {ko:'졸리다', ro:'a fi somnoros', en:'to be sleepy', aliases:['sunt somnoros','ești somnoros','este somnoros','suntem somnoroși','sunteți somnoroși','sunt somnoroși','somnoros','e somnoros','sleepy','is sleepy','are sleepy'], final:'졸려요', forms:{none:'졸려요',seq:'졸리고',cause1:'졸려서',cause2:'졸리니까',condition:'졸리면',contrast1:'졸리지만',contrast2:'졸린데',purpose:'졸리려고',result:'졸려서 그렇게 되다'}},
      {ko:'좁다', ro:'a fi îngust', en:'narrow', aliases:['sunt îngust','ești îngust','este îngust','suntem înguști','sunteți înguști','sunt înguști','îngust','e îngust','narrow','is narrow','are narrow'], final:'좁아요', forms:{none:'좁아요',seq:'좁고',cause1:'좁아서',cause2:'좁으니까',condition:'좁으면',contrast1:'좁지만',contrast2:'좁은데',purpose:'좁으려고',result:'좁아서 그렇게 되다'}},
      {ko:'좋다', ro:'a fi bun', en:'good', aliases:['sunt bun','ești bun','este bun','suntem buni','sunteți buni','sunt buni','bun','e bun','good','is good','are good'], final:'좋아요', forms:{none:'좋아요',seq:'좋고',cause1:'좋아서',cause2:'좋으니까',condition:'좋으면',contrast1:'좋지만',contrast2:'좋은데',purpose:'좋으려고',result:'좋아서 그렇게 되다'}},
      ...
      {ko:'중요하다', ro:'a fi important', en:'important', aliases:['sunt important','ești important','este important','suntem importanți','sunteți importanți','sunt importanți','important','e important','is important','are important'], final:'중요해요', forms:{none:'중요해요',seq:'중요하고',cause1:'중요해서',cause2:'중요하니까',condition:'중요하면',contrast1:'중요하지만',contrast2:'중요한데',purpose:'중요하려고',result:'중요해서 그렇게 되다'}},
      {ko:'즐겁다', ro:'a fi plăcut', en:'to be fun / enjoyable', aliases:['sunt plăcut','ești plăcut','este plăcut','suntem plăcuți','sunteți plăcuți','sunt plăcuți','plăcut','e plăcut','distractiv','sunt distractiv','e distractiv','fun','is fun','are fun','enjoyable','is enjoyable','are enjoyable'], final:'즐거워요', forms:{none:'즐거워요',seq:'즐겁고',cause1:'즐거워서',cause2:'즐거우니까',condition:'즐거우면',contrast1:'즐겁지만',contrast2:'즐거운데',purpose:'즐거우려고',result:'즐거워서 그렇게 되다'}},
      {ko:'지루하다', ro:'a fi plictisitor', en:'to be boring, tedious', aliases:['sunt plictisitor','ești plictisitor','este plictisitor','suntem plictisitori','sunteți plictisitori','sunt plictisitori','plictisitor','e plictisitor','boring','is boring','are boring','tedious','is tedious','are tedious'], final:'지루해요', forms:{none:'지루해요',seq:'지루하고',cause1:'지루해서',cause2:'지루하니까',condition:'지루하면',contrast1:'지루하지만',contrast2:'지루한데',purpose:'지루하려고',result:'지루해서 그렇게 되다'}},
      {ko:'짜다', ro:'a fi sărat', en:'to be salty', aliases:['sunt sărat','ești sărat','este sărat','suntem sărați','sunteți sărați','sunt sărați','sărat','e sărat','salty','is salty','are salty'], final:'짜요', forms:{none:'짜요',seq:'짜고',cause1:'짜서',cause2:'짜니까',condition:'짜면',contrast1:'짜지만',contrast2:'짠데',purpose:'짜려고',result:'짜서 그렇게 되다'}},
      {ko:'짜증나다', ro:'a fi enervant', en:'to be annoyed', aliases:['sunt enervant','ești enervant','este enervant','suntem enervanți','sunteți enervanți','sunt enervanți','enervant','e enervant','iritat','sunt iritat','e iritat','annoyed','is annoyed','are annoyed'], final:'짜증나요', forms:{none:'짜증나요',seq:'짜증나고',cause1:'짜증나서',cause2:'짜증나니까',condition:'짜증나면',contrast1:'짜증나지만',contrast2:'짜증나는데',purpose:'짜증나려고',result:'짜증나서 그렇게 되다'}},
      {ko:'짧다', ro:'a fi scurt', en:'short', aliases:['sunt scurt','ești scurt','este scurt','suntem scurți','sunteți scurți','sunt scurți','scurt','e scurt','short','is short','are short'], final:'짧아요', forms:{none:'짧아요',seq:'짧고',cause1:'짧아서',cause2:'짧으니까',condition:'짧으면',contrast1:'짧지만',contrast2:'짧은데',purpose:'짧으려고',result:'짧아서 그렇게 되다'}},
      {ko:'차갑다', ro:'a fi rece', en:'cold', aliases:['sunt rece','ești rece','este rece','suntem reci','sunteți reci','sunt reci','rece','e rece','cold','is cold','are cold'], final:'차가워요', forms:{none:'차가워요',seq:'차갑고',cause1:'차가워서',cause2:'차가우니까',condition:'차가우면',contrast1:'차갑지만',contrast2:'차가운데',purpose:'차가우려고',result:'차가워서 그렇게 되다'}},
      ...
      {ko:'창피하다', ro:'a fi rușinos', en:'to be embarrassed', aliases:['sunt rușinos','ești rușinos','este rușinos','suntem rușinoși','sunteți rușinoși','sunt rușinoși','rușinos','e rușinos','jenat','sunt jenat','e jenat','embarrassed','is embarrassed','are embarrassed'], final:'창피해요', forms:{none:'창피해요',seq:'창피하고',cause1:'창피해서',cause2:'창피하니까',condition:'창피하면',contrast1:'창피하지만',contrast2:'창피한데',purpose:'창피하려고',result:'창피해서 그렇게 되다'}},
      {ko:'초조하다', ro:'a fi neliniștit', en:'to be anxious', aliases:['sunt neliniștit','ești neliniștit','este neliniștit','suntem neliniștiți','sunteți neliniștiți','sunt neliniștiți','neliniștit','e neliniștit','anxious','is anxious','are anxious'], final:'초조해요', forms:{none:'초조해요',seq:'초조하고',cause1:'초조해서',cause2:'초조하니까',condition:'초조하면',contrast1:'초조하지만',contrast2:'초조한데',purpose:'초조하려고',result:'초조해서 그렇게 되다'}},
      ...
      {ko:'충분하다', ro:'a fi suficient', en:'to be enough, sufficient', aliases:['sunt suficient','ești suficient','este suficient','suntem suficienți','sunteți suficienți','sunt suficienți','suficient','e suficient','enough','is enough','are enough','sufficient','is sufficient','are sufficient'], final:'충분해요', forms:{none:'충분해요',seq:'충분하고',cause1:'충분해서',cause2:'충분하니까',condition:'충분하면',contrast1:'충분하지만',contrast2:'충분한데',purpose:'충분하려고',result:'충분해서 그렇게 되다'}},
      {ko:'친절하다', ro:'a fi amabil', en:'kind', aliases:['sunt amabil','ești amabil','este amabil','suntem amabili','sunteți amabili','sunt amabili','amabil','e amabil','kind','is kind','are kind'], final:'친절해요', forms:{none:'친절해요',seq:'친절하고',cause1:'친절해서',cause2:'친절하니까',condition:'친절하면',contrast1:'친절하지만',contrast2:'친절한데',purpose:'친절하려고',result:'친절해서 그렇게 되다'}},
      {ko:'크다', ro:'a fi mare', en:'big', aliases:['sunt mare','ești mare','este mare','suntem mari','sunteți mari','sunt mari','mare','e mare','big','is big','are big'], final:'커요', forms:{none:'커요',seq:'크고',cause1:'커서',cause2:'크니까',condition:'크면',contrast1:'크지만',contrast2:'큰데',purpose:'크려고',result:'커서 그렇게 되다'}},
      {ko:'특별하다', ro:'a fi special', en:'to be special', aliases:['sunt special','ești special','este special','suntem speciali','sunteți speciali','sunt speciali','special','e special','is special','are special'], final:'특별해요', forms:{none:'특별해요',seq:'특별하고',cause1:'특별해서',cause2:'특별하니까',condition:'특별하면',contrast1:'특별하지만',contrast2:'특별한데',purpose:'특별하려고',result:'특별해서 그렇게 되다'}},
      {ko:'틀리다', ro:'a fi greșit', en:'to be wrong, to be mistaken', aliases:['sunt greșit','ești greșit','este greșit','suntem greșiți','sunteți greșiți','sunt greșiți','greșit','e greșit','wrong','is wrong','are wrong','mistaken','is mistaken','are mistaken'], final:'틀려요', forms:{none:'틀려요',seq:'틀리고',cause1:'틀려서',cause2:'틀리니까',condition:'틀리면',contrast1:'틀리지만',contrast2:'틀린데',purpose:'틀리려고',result:'틀려서 그렇게 되다'}},
      {ko:'편리하다', ro:'a fi convenabil', en:'to be convenient', aliases:['sunt convenabil','ești convenabil','este convenabil','suntem convenabili','sunteți convenabili','sunt convenabili','convenabil','e convenabil','convenient','is convenient','are convenient'], final:'편리해요', forms:{none:'편리해요',seq:'편리하고',cause1:'편리해서',cause2:'편리하니까',condition:'편리하면',contrast1:'편리하지만',contrast2:'편리한데',purpose:'편리하려고',result:'편리해서 그렇게 되다'}},
      {ko:'편안하다', ro:'a fi relaxat', en:'to be relaxed / comfortable', aliases:['sunt relaxat','ești relaxat','este relaxat','suntem relaxați','sunteți relaxați','sunt relaxați','relaxat','e relaxat','confortabil','sunt confortabil','e confortabil','relaxed','is relaxed','are relaxed','comfortable','is comfortable','are comfortable'], final:'편안해요', forms:{none:'편안해요',seq:'편안하고',cause1:'편안해서',cause2:'편안하니까',condition:'편안하면',contrast1:'편안하지만',contrast2:'편안한데',purpose:'편안하려고',result:'편안해서 그렇게 되다'}},
      {ko:'편하다', ro:'a fi comod', en:'to be comfortable', aliases:['sunt comod','ești comod','este comod','suntem comozi','sunteți comozi','sunt comozi','comod','e comod','confortabil','sunt confortabil','e confortabil','comfortable','is comfortable','are comfortable'], final:'편해요', forms:{none:'편해요',seq:'편하고',cause1:'편해서',cause2:'편하니까',condition:'편하면',contrast1:'편하지만',contrast2:'편한데',purpose:'편하려고',result:'편해서 그렇게 되다'}},
      {ko:'평범하다', ro:'a fi obișnuit', en:'to be ordinary, average', aliases:['sunt obișnuit','ești obișnuit','este obișnuit','suntem obișnuiți','sunteți obișnuiți','sunt obișnuiți','obișnuit','e obișnuit','normal','sunt normal','e normal','ordinary','is ordinary','are ordinary','average','is average','are average'], final:'평범해요', forms:{none:'평범해요',seq:'평범하고',cause1:'평범해서',cause2:'평범하니까',condition:'평범하면',contrast1:'평범하지만',contrast2:'평범한데',purpose:'평범하려고',result:'평범해서 그렇게 되다'}},
      {ko:'필요하다', ro:'a fi necesar', en:'necessary', aliases:['sunt necesar','ești necesar','este necesar','suntem necesari','sunteți necesari','sunt necesari','necesar','e necesar','necessary','is necessary','are necessary'], final:'필요해요', forms:{none:'필요해요',seq:'필요하고',cause1:'필요해서',cause2:'필요하니까',condition:'필요하면',contrast1:'필요하지만',contrast2:'필요한데',purpose:'필요하려고',result:'필요해서 그렇게 되다'}},
      {ko:'하얗다', ro:'a fi alb', en:'white', aliases:['sunt alb','ești alb','este alb','suntem albi','sunteți albi','sunt albi','alb','e alb','white','is white','are white'], final:'하얘요', forms:{none:'하얘요',seq:'하얗고',cause1:'하얘서',cause2:'하야니까',condition:'하야면',contrast1:'하얗지만',contrast2:'하얀데',purpose:'하야려고',result:'하얘서 그렇게 되다'}},
      {ko:'학문적이다', ro:'a fi academic', en:'academic', aliases:['sunt academic','ești academic','este academic','suntem academici','sunteți academici','sunt academici','academic','e academic','is academic','are academic'], final:'학문적이에요', forms:{none:'학문적이에요',seq:'학문적이고',cause1:'학문적이에서',cause2:'학문적이니까',condition:'학문적이면',contrast1:'학문적이지만',contrast2:'학문적인데',purpose:'학문적이려고',result:'학문적이에서 그렇게 되다'}},
      {ko:'행복하다', ro:'a fi fericit', en:'happy', aliases:['sunt fericit','ești fericit','este fericit','suntem fericiți','sunteți fericiți','sunt fericiți','fericit','e fericit','happy','is happy','are happy'], final:'행복해요', forms:{none:'행복해요',seq:'행복하고',cause1:'행복해서',cause2:'행복하니까',condition:'행복하면',contrast1:'행복하지만',contrast2:'행복한데',purpose:'행복하려고',result:'행복해서 그렇게 되다'}},
      {ko:'현대적이다', ro:'a fi modern', en:'modern', aliases:['sunt modern','ești modern','este modern','suntem moderni','sunteți moderni','sunt moderni','modern','e modern','is modern','are modern'], final:'현대적이에요', forms:{none:'현대적이에요',seq:'현대적이고',cause1:'현대적이에서',cause2:'현대적이니까',condition:'현대적이면',contrast1:'현대적이지만',contrast2:'현대적인데',purpose:'현대적이려고',result:'현대적이에서 그렇게 되다'}},
      {ko:'확실하다', ro:'a fi sigur', en:'to be certain', aliases:['sunt sigur','ești sigur','este sigur','suntem siguri','sunteți siguri','sunt siguri','sigur','e sigur','cert','sunt cert','e cert','certain','is certain','are certain'], final:'확실해요', forms:{none:'확실해요',seq:'확실하고',cause1:'확실해서',cause2:'확실하니까',condition:'확실하면',contrast1:'확실하지만',contrast2:'확실한데',purpose:'확실하려고',result:'확실해서 그렇게 되다'}},
      ...
      {ko:'효율적이다', ro:'a fi eficient', en:'efficient', aliases:['sunt eficient','ești eficient','este eficient','suntem eficienți','sunteți eficienți','sunt eficienți','eficient','e eficient','efficient','is efficient','are efficient'], final:'효율적이에요', forms:{none:'효율적이에요',seq:'효율적이고',cause1:'효율적이에서',cause2:'효율적이니까',condition:'효율적이면',contrast1:'효율적이지만',contrast2:'효율적인데',purpose:'효율적이려고',result:'효율적이에서 그렇게 되다'}},
      {ko:'훌륭하다', ro:'a fi excelent', en:'to be excellent', aliases:['sunt excelent','ești excelent','este excelent','suntem excelenți','sunteți excelenți','sunt excelenți','excelent','e excelent','excellent','is excellent','are excellent'], final:'훌륭해요', forms:{none:'훌륭해요',seq:'훌륭하고',cause1:'훌륭해서',cause2:'훌륭하니까',condition:'훌륭하면',contrast1:'훌륭하지만',contrast2:'훌륭한데',purpose:'훌륭하려고',result:'훌륭해서 그렇게 되다'}},
      {ko:'흐리다', ro:'a fi înnorat', en:'to be cloudy/overcast', aliases:['sunt înnorat','ești înnorat','este înnorat','suntem înnorați','sunteți înnorați','sunt înnorați','înnorat','e înnorat','cloudy','is cloudy','are cloudy','overcast','is overcast','are overcast'], final:'흐려요', forms:{none:'흐려요',seq:'흐리고',cause1:'흐려서',cause2:'흐리니까',condition:'흐리면',contrast1:'흐리지만',contrast2:'흐린데',purpose:'흐리려고',result:'흐려서 그렇게 되다'}},
      {ko:'힘들다', ro:'a fi greu', en:'hard', aliases:['sunt greu','ești greu','este greu','suntem grei','sunteți grei','sunt grei','greu','e greu','hard','is hard','are hard'], final:'힘들어요', forms:{none:'힘들어요',seq:'힘들고',cause1:'힘들어서',cause2:'힘드니까',condition:'힘드면',contrast1:'힘들지만',contrast2:'힘든데',purpose:'힘드려고',result:'힘들어서 그렇게 되다'}},
      {ko:'궁금하다', ro:'a fi curios', en:'to be curious', aliases:['sunt curios','ești curios','este curios','suntem curioși','sunteți curioși','sunt curioși','curios','e curios','curious','is curious','are curious'], final:'궁금해요', forms:{none:'궁금해요',seq:'궁금하고',cause1:'궁금해서',cause2:'궁금하니까',condition:'궁금하면',contrast1:'궁금하지만',contrast2:'궁금한데',purpose:'궁금하려고',result:'궁금해서 그렇게 되다'}},
      ...
      {ko:'사랑스럽다', ro:'a fi drăgălaș', en:'to be lovable', aliases:['sunt drăgălaș','ești drăgălaș','este drăgălaș','suntem drăgălași','sunteți drăgălași','sunt drăgălași','drăgălaș','e drăgălaș','lovable','is lovable','are lovable'], final:'사랑스러워요', forms:{none:'사랑스러워요',seq:'사랑스럽고',cause1:'사랑스러워서',cause2:'사랑스러우니까',condition:'사랑스러우면',contrast1:'사랑스럽지만',contrast2:'사랑스러운데',purpose:'사랑스러우려고',result:'사랑스러워서 그렇게 되다'}},
    ],
    connector: [
