(function(){
  ...
  var DATA = {
    ...
    verb: [
      ...
      {ko:'가져다 주다', ro:'a aduce cuiva', en:'to bring to someone', aliases:['aduce cuiva','bring to someone'], final:'가져다 줘요', forms:{none:'가져다 줘요',seq:'가져다 주고',cause1:'가져다 줘서',cause2:'가져다 주니까',condition:'가져다 주면',contrast1:'가져다 주지만',contrast2:'가져다 주는데',purpose:'가져다 주려고',result:'가져다 줘서 그렇게 되다'}},
      {ko:'가지다', ro:'a avea / a deține', en:'to have / to hold', aliases:['are','avea','deține','have','hold'], final:'가져요', forms:{none:'가져요',seq:'가지고',cause1:'가져서',cause2:'가지니까',condition:'가지면',contrast1:'가지지만',contrast2:'가지는데',purpose:'가지려고',result:'가져서 그렇게 되다'}},
      {ko:'갈아타다', ro:'a face transbordare', en:'to transfer (transport)', aliases:['face transbordare','transfer'], final:'갈아타요', forms:{none:'갈아타요',seq:'갈아타고',cause1:'갈아타서',cause2:'갈아타니까',condition:'갈아타면',contrast1:'갈아타지만',contrast2:'갈아타는데',purpose:'갈아타려고',result:'갈아타서 그렇게 되다'}},
      {ko:'감다', ro:'a spăla (părul) / a închide (ochii)', en:'to wash (hair) / to close (eyes)', aliases:['spală','spăla','închide','wash','close'], final:'감아요', forms:{none:'감아요',seq:'감고',cause1:'감아서',cause2:'감으니까',condition:'감으면',contrast1:'감지만',contrast2:'감는데',purpose:'감으려고',result:'감아서 그렇게 되다'}},
      {ko:'감동하다', ro:'a fi emoționat / mișcat', en:'to be moved (emotionally)', aliases:['e emoționat','fi emoționat','mișcat','be moved'], final:'감동해요', forms:{none:'감동해요',seq:'감동하고',cause1:'감동해서',cause2:'감동하니까',condition:'감동하면',contrast1:'감동하지만',contrast2:'감동하는데',purpose:'감동하려고',result:'감동해서 그렇게 되다'}},
      {ko:'개발하다', ro:'a dezvolta', en:'to develop', aliases:['dezvoltă','dezvolta','develop'], final:'개발해요', forms:{none:'개발해요',seq:'개발하고',cause1:'개발해서',cause2:'개발하니까',condition:'개발하면',contrast1:'개발하지만',contrast2:'개발하는데',purpose:'개발하려고',result:'개발해서 그렇게 되다'}},
      {ko:'거절하다', ro:'a refuza', en:'to refuse, to decline', aliases:['refuză','refuza','refuse','decline'], final:'거절해요', forms:{none:'거절해요',seq:'거절하고',cause1:'거절해서',cause2:'거절하니까',condition:'거절하면',contrast1:'거절하지만',contrast2:'거절하는데',purpose:'거절하려고',result:'거절해서 그렇게 되다'}},
      {ko:'걱정하다', ro:'a-și face griji', en:'to worry', aliases:['își face griji','face griji','worry'], final:'걱정해요', forms:{none:'걱정해요',seq:'걱정하고',cause1:'걱정해서',cause2:'걱정하니까',condition:'걱정하면',contrast1:'걱정하지만',contrast2:'걱정하는데',purpose:'걱정하려고',result:'걱정해서 그렇게 되다'}},
      {ko:'건강해지다', ro:'a deveni sănătos', en:'to become healthy', aliases:['devine sănătos','deveni sănătos','become healthy'], final:'건강해져요', forms:{none:'건강해져요',seq:'건강해지고',cause1:'건강해져서',cause2:'건강해지니까',condition:'건강해지면',contrast1:'건강해지지만',contrast2:'건강해지는데',purpose:'건강해지려고',result:'건강해져서 그렇게 되다'}},
      {ko:'건너다', ro:'a traversa', en:'to cross', aliases:['traversează','traversa','cross'], final:'건너어요', forms:{none:'건너어요',seq:'건너고',cause1:'건너어서',cause2:'건너니까',condition:'건너면',contrast1:'건너지만',contrast2:'건너는데',purpose:'건너려고',result:'건너어서 그렇게 되다'}},
      {ko:'걷다', ro:'a merge pe jos', en:'to walk', aliases:['merge pe jos','walk'], final:'걸어요', forms:{none:'걸어요',seq:'걷고',cause1:'걸어서',cause2:'걷으니까',condition:'걷으면',contrast1:'걷지만',contrast2:'걷는데',purpose:'걷으려고',result:'걸어서 그렇게 되다'}},
      {ko:'걸다', ro:'a agăța / a suna (telefon)', en:'to hang / to make a call', aliases:['agață','agăța','suna','hang','make a call'], final:'걸어요', forms:{none:'걸어요',seq:'걸고',cause1:'걸어서',cause2:'걸니까',condition:'걸면',contrast1:'걸지만',contrast2:'걸는데',purpose:'걸려고',result:'걸어서 그렇게 되다'}},
      {ko:'걸리다', ro:'a se îmbolnăvi, a dura', en:'to catch (illness), to take (time)', aliases:['se îmbolnăvește','îmbolnăvi','dura','catch','take'], final:'걸려요', forms:{none:'걸려요',seq:'걸리고',cause1:'걸려서',cause2:'걸리니까',condition:'걸리면',contrast1:'걸리지만',contrast2:'걸리는데',purpose:'걸리려고',result:'걸려서 그렇게 되다'}},
      {ko:'검색하다', ro:'a căuta (online)', en:'to search', aliases:['caută','căuta','search'], final:'검색해요', forms:{none:'검색해요',seq:'검색하고',cause1:'검색해서',cause2:'검색하니까',condition:'검색하면',contrast1:'검색하지만',contrast2:'검색하는데',purpose:'검색하려고',result:'검색해서 그렇게 되다'}},
      {ko:'계산하다', ro:'a calcula, a plăti nota', en:'to calculate, to pay the bill', aliases:['calculează','calcula','plăti nota','calculate','pay the bill'], final:'계산해요', forms:{none:'계산해요',seq:'계산하고',cause1:'계산해서',cause2:'계산하니까',condition:'계산하면',contrast1:'계산하지만',contrast2:'계산하는데',purpose:'계산하려고',result:'계산해서 그렇게 되다'}},
      {ko:'고민하다', ro:'a se frământa / a chibzui', en:'to worry / to agonize over', aliases:['se frământă','frământa','chibzui','worry','agonize over'], final:'고민해요', forms:{none:'고민해요',seq:'고민하고',cause1:'고민해서',cause2:'고민하니까',condition:'고민하면',contrast1:'고민하지만',contrast2:'고민하는데',purpose:'고민하려고',result:'고민해서 그렇게 되다'}},
      {ko:'고치다', ro:'a repara, a corecta', en:'to fix, to repair', aliases:['repară','repara','corecta','fix','repair'], final:'고쳐요', forms:{none:'고쳐요',seq:'고치고',cause1:'고쳐서',cause2:'고치니까',condition:'고치면',contrast1:'고치지만',contrast2:'고치는데',purpose:'고치려고',result:'고쳐서 그렇게 되다'}},
      {ko:'구경하다', ro:'a răsfoi, a se uita', en:'to browse, to look around', aliases:['răsfoiește','răsfoi','uita','browse','look around'], final:'구경해요', forms:{none:'구경해요',seq:'구경하고',cause1:'구경해서',cause2:'구경하니까',condition:'구경하면',contrast1:'구경하지만',contrast2:'구경하는데',purpose:'구경하려고',result:'구경해서 그렇게 되다'}},
      {ko:'굽다', ro:'a prăji, a coace', en:'to grill, to bake', aliases:['prăjește','prăji','coace','grill','bake'], final:'구워요', forms:{none:'구워요',seq:'굽고',cause1:'구워서',cause2:'굽으니까',condition:'굽으면',contrast1:'굽지만',contrast2:'굽는데',purpose:'굽으려고',result:'구워서 그렇게 되다'}},
      {ko:'그리다', ro:'a desena, a picta', en:'to draw, to paint', aliases:['desenează','desena','picta','draw','paint'], final:'그려요', forms:{none:'그려요',seq:'그리고',cause1:'그려서',cause2:'그리니까',condition:'그리면',contrast1:'그리지만',contrast2:'그리는데',purpose:'그리려고',result:'그려서 그렇게 되다'}},
      {ko:'그만두다', ro:'a renunța / a demisiona', en:'to quit', aliases:['renunță','renunța','demisiona','quit'], final:'그만둬요', forms:{none:'그만둬요',seq:'그만두고',cause1:'그만둬서',cause2:'그만두니까',condition:'그만두면',contrast1:'그만두지만',contrast2:'그만두는데',purpose:'그만두려고',result:'그만둬서 그렇게 되다'}},
      {ko:'그치다', ro:'a se opri (ploaia/ninsoarea)', en:'to stop (rain/snow)', aliases:['se oprește','opri','stop'], final:'그쳐요', forms:{none:'그쳐요',seq:'그치고',cause1:'그쳐서',cause2:'그치니까',condition:'그치면',contrast1:'그치지만',contrast2:'그치는데',purpose:'그치려고',result:'그쳐서 그렇게 되다'}},
      {ko:'긴장하다', ro:'a fi tensionat / emoționat', en:'to be nervous', aliases:['e tensionat','fi tensionat','emoționat','be nervous'], final:'긴장해요', forms:{none:'긴장해요',seq:'긴장하고',cause1:'긴장해서',cause2:'긴장하니까',condition:'긴장하면',contrast1:'긴장하지만',contrast2:'긴장하는데',purpose:'긴장하려고',result:'긴장해서 그렇게 되다'}},
      {ko:'김치찌개를 끓이다', ro:'a face supă kimchi', en:'to make kimchi jjigae', aliases:['face supă kimchi','make kimchi jjigae'], final:'김치찌개를 끓여요', forms:{none:'김치찌개를 끓여요',seq:'김치찌개를 끓이고',cause1:'김치찌개를 끓여서',cause2:'김치찌개를 끓이니까',condition:'김치찌개를 끓이면',contrast1:'김치찌개를 끓이지만',contrast2:'김치찌개를 끓이는데',purpose:'김치찌개를 끓이려고',result:'김치찌개를 끓여서 그렇게 되다'}},
      {ko:'깨다', ro:'a se trezi / a sparge', en:'to wake up / to break', aliases:['se trezește','trezi','sparge','wake up','break'], final:'깨어요', forms:{none:'깨어요',seq:'깨고',cause1:'깨어서',cause2:'깨니까',condition:'깨면',contrast1:'깨지만',contrast2:'깨는데',purpose:'깨려고',result:'깨어서 그렇게 되다'}},
      {ko:'꺼내다', ro:'a scoate afară', en:'to take out', aliases:['scoate afară','take out'], final:'꺼내어요', forms:{none:'꺼내어요',seq:'꺼내고',cause1:'꺼내어서',cause2:'꺼내니까',condition:'꺼내면',contrast1:'꺼내지만',contrast2:'꺼내는데',purpose:'꺼내려고',result:'꺼내어서 그렇게 되다'}},
      {ko:'끄다', ro:'a stinge, a opri', en:'to turn off', aliases:['stinge','opri','turn off'], final:'꺼요', forms:{none:'꺼요',seq:'끄고',cause1:'꺼서',cause2:'끄니까',condition:'끄면',contrast1:'끄지만',contrast2:'끄는데',purpose:'끄려고',result:'꺼서 그렇게 되다'}},
      {ko:'끓이다', ro:'a fierbe', en:'to boil', aliases:['fierbe','boil'], final:'끓여요', forms:{none:'끓여요',seq:'끓이고',cause1:'끓여서',cause2:'끓이니까',condition:'끓이면',contrast1:'끓이지만',contrast2:'끓이는데',purpose:'끓이려고',result:'끓여서 그렇게 되다'}},
      {ko:'끝나다', ro:'a se termina', en:'to finish', aliases:['se termină','termina','finish'], final:'끝나요', forms:{none:'끝나요',seq:'끝나고',cause1:'끝나서',cause2:'끝나니까',condition:'끝나면',contrast1:'끝나지만',contrast2:'끝나는데',purpose:'끝나려고',result:'끝나서 그렇게 되다'}},
      {ko:'끝내다', ro:'a termina', en:'to finish, to complete', aliases:['termină','termina','finish','complete'], final:'끝내어요', forms:{none:'끝내어요',seq:'끝내고',cause1:'끝내어서',cause2:'끝내니까',condition:'끝내면',contrast1:'끝내지만',contrast2:'끝내는데',purpose:'끝내려고',result:'끝내어서 그렇게 되다'}},
      {ko:'끼다', ro:'a purta (inel, mănuși)', en:'to wear (ring, gloves)', aliases:['poartă','purta','wear'], final:'껴요', forms:{none:'껴요',seq:'끼고',cause1:'껴서',cause2:'끼니까',condition:'끼면',contrast1:'끼지만',contrast2:'끼는데',purpose:'끼려고',result:'껴서 그렇게 되다'}},
      {ko:'나가다', ro:'a ieși afară', en:'to go out', aliases:['iese afară','ieși afară','go out'], final:'나가요', forms:{none:'나가요',seq:'나가고',cause1:'나가서',cause2:'나가니까',condition:'나가면',contrast1:'나가지만',contrast2:'나가는데',purpose:'나가려고',result:'나가서 그렇게 되다'}},
      {ko:'나누다', ro:'a împărți, a diviza', en:'to share, to divide', aliases:['împarte','împărți','diviza','share','divide'], final:'나눠요', forms:{none:'나눠요',seq:'나누고',cause1:'나눠서',cause2:'나누니까',condition:'나누면',contrast1:'나누지만',contrast2:'나누는데',purpose:'나누려고',result:'나눠서 그렇게 되다'}},
      {ko:'나빠지다', ro:'a se înrăutăți', en:'to get worse, to deteriorate', aliases:['se înrăutățește','înrăutăți','get worse','deteriorate'], final:'나빠져요', forms:{none:'나빠져요',seq:'나빠지고',cause1:'나빠져서',cause2:'나빠지니까',condition:'나빠지면',contrast1:'나빠지지만',contrast2:'나빠지는데',purpose:'나빠지려고',result:'나빠져서 그렇게 되다'}},
      {ko:'나아가다', ro:'a avansa, a înainta', en:'to move forward, to advance', aliases:['avansează','avansa','înainta','move forward','advance'], final:'나아가요', forms:{none:'나아가요',seq:'나아가고',cause1:'나아가서',cause2:'나아가니까',condition:'나아가면',contrast1:'나아가지만',contrast2:'나아가는데',purpose:'나아가려고',result:'나아가서 그렇게 되다'}},
      {ko:'나오다', ro:'a ieși, a apărea', en:'to come out, to appear', aliases:['iese','ieși','apărea','come out','appear'], final:'나와요', forms:{none:'나와요',seq:'나오고',cause1:'나와서',cause2:'나오니까',condition:'나오면',contrast1:'나오지만',contrast2:'나오는데',purpose:'나오려고',result:'나와서 그렇게 되다'}},
      {ko:'나타나다', ro:'a apărea', en:'to appear, to show up', aliases:['apare','apărea','appear','show up'], final:'나타나요', forms:{none:'나타나요',seq:'나타나고',cause1:'나타나서',cause2:'나타나니까',condition:'나타나면',contrast1:'나타나지만',contrast2:'나타나는데',purpose:'나타나려고',result:'나타나서 그렇게 되다'}},
      {ko:'날씨가 좋다', ro:'a fi vreme frumoasă', en:'weather is nice', aliases:['e vreme frumoasă','fi vreme frumoasă','weather is nice'], final:'날씨가 좋아요', forms:{none:'날씨가 좋아요',seq:'날씨가 좋고',cause1:'날씨가 좋아서',cause2:'날씨가 좋으니까',condition:'날씨가 좋으면',contrast1:'날씨가 좋지만',contrast2:'날씨가 좋는데',purpose:'날씨가 좋으려고',result:'날씨가 좋아서 그렇게 되다'}},
      {ko:'낫다', ro:'a se recupera, a se face bine', en:'to recover, to get better', aliases:['se recuperează','recupera','face bine','recover','get better'], final:'낫아요', forms:{none:'낫아요',seq:'낫고',cause1:'낫아서',cause2:'낫으니까',condition:'낫으면',contrast1:'낫지만',contrast2:'낫는데',purpose:'낫으려고',result:'낫아서 그렇게 되다'}},
      {ko:'낮추다', ro:'a coborî, a reduce', en:'to lower', aliases:['coboară','coborî','reduce','lower'], final:'낮춰요', forms:{none:'낮춰요',seq:'낮추고',cause1:'낮춰서',cause2:'낮추니까',condition:'낮추면',contrast1:'낮추지만',contrast2:'낮추는데',purpose:'낮추려고',result:'낮춰서 그렇게 되다'}},
      {ko:'내다', ro:'a produce, a scoate', en:'to produce, to put out', aliases:['produce','scoate','put out'], final:'내어요', forms:{none:'내어요',seq:'내고',cause1:'내어서',cause2:'내니까',condition:'내면',contrast1:'내지만',contrast2:'내는데',purpose:'내려고',result:'내어서 그렇게 되다'}},
      {ko:'내려가다', ro:'a coborî', en:'to go down', aliases:['coboară','coborî','go down'], final:'내려가요', forms:{none:'내려가요',seq:'내려가고',cause1:'내려가서',cause2:'내려가니까',condition:'내려가면',contrast1:'내려가지만',contrast2:'내려가는데',purpose:'내려가려고',result:'내려가서 그렇게 되다'}},
      {ko:'내리다', ro:'a coborî din mijloc de transport', en:'to get off, to get out', aliases:['coboară din mijloc de transport','coborî din mijloc de transport','get off','get out'], final:'내려요', forms:{none:'내려요',seq:'내리고',cause1:'내려서',cause2:'내리니까',condition:'내리면',contrast1:'내리지만',contrast2:'내리는데',purpose:'내리려고',result:'내려서 그렇게 되다'}},
      {ko:'넘다', ro:'a depăși / a trece peste', en:'to exceed / go over', aliases:['depășește','depăși','trece peste','exceed','go over'], final:'넘어요', forms:{none:'넘어요',seq:'넘고',cause1:'넘어서',cause2:'넘으니까',condition:'넘으면',contrast1:'넘지만',contrast2:'넘는데',purpose:'넘으려고',result:'넘어서 그렇게 되다'}},
      {ko:'넘어지다', ro:'a cădea', en:'to fall over', aliases:['cade','cădea','fall over'], final:'넘어져요', forms:{none:'넘어져요',seq:'넘어지고',cause1:'넘어져서',cause2:'넘어지니까',condition:'넘어지면',contrast1:'넘어지지만',contrast2:'넘어지는데',purpose:'넘어지려고',result:'넘어져서 그렇게 되다'}},
      {ko:'넣다', ro:'a pune înăuntru', en:'to put in, insert', aliases:['pune înăuntru','put in','insert'], final:'넣어요', forms:{none:'넣어요',seq:'넣고',cause1:'넣어서',cause2:'넣으니까',condition:'넣으면',contrast1:'넣지만',contrast2:'넣는데',purpose:'넣으려고',result:'넣어서 그렇게 되다'}},
      {ko:'놀다', ro:'a se juca', en:'to play', aliases:['se joacă','juca','play'], final:'놀아요', forms:{none:'놀아요',seq:'놀고',cause1:'놀아서',cause2:'놀니까',condition:'놀면',contrast1:'놀지만',contrast2:'놀는데',purpose:'놀려고',result:'놀아서 그렇게 되다'}},
      {ko:'놀라다', ro:'a se speria / a fi surprins', en:'to be surprised', aliases:['se sperie','speria','fi surprins','be surprised'], final:'놀라요', forms:{none:'놀라요',seq:'놀라고',cause1:'놀라서',cause2:'놀라니까',condition:'놀라면',contrast1:'놀라지만',contrast2:'놀라는데',purpose:'놀라려고',result:'놀라서 그렇게 되다'}},
      {ko:'누르다', ro:'a apăsa, a strânge', en:'to press, to push', aliases:['apasă','apăsa','strânge','press','push'], final:'눌러요', forms:{none:'눌러요',seq:'누르고',cause1:'눌러서',cause2:'누르니까',condition:'누르면',contrast1:'누르지만',contrast2:'누르는데',purpose:'누르려고',result:'눌러서 그렇게 되다'}},
      {ko:'눕다', ro:'a se culca, a se întinde', en:'to lie down', aliases:['se culcă','culca','întinde','lie down'], final:'누워요', forms:{none:'누워요',seq:'눕고',cause1:'누워서',cause2:'눕으니까',condition:'눕으면',contrast1:'눕지만',contrast2:'눕는데',purpose:'눕으려고',result:'누워서 그렇게 되다'}},
      {ko:'늘다', ro:'a crește, a se îmbunătăți', en:'to increase, to improve', aliases:['crește','îmbunătăți','increase','improve'], final:'늘어요', forms:{none:'늘어요',seq:'늘고',cause1:'늘어서',cause2:'늘니까',condition:'늘면',contrast1:'늘지만',contrast2:'늘는데',purpose:'늘려고',result:'늘어서 그렇게 되다'}},
      {ko:'늘리다', ro:'a mări, a extinde', en:'to increase, to extend', aliases:['mărește','mări','extinde','increase','extend'], final:'늘려요', forms:{none:'늘려요',seq:'늘리고',cause1:'늘려서',cause2:'늘리니까',condition:'늘리면',contrast1:'늘리지만',contrast2:'늘리는데',purpose:'늘리려고',result:'늘려서 그렇게 되다'}},
      {ko:'늘어나다', ro:'a crește (în număr)', en:'to increase', aliases:['crește','increase'], final:'늘어나요', forms:{none:'늘어나요',seq:'늘어나고',cause1:'늘어나서',cause2:'늘어나니까',condition:'늘어나면',contrast1:'늘어나지만',contrast2:'늘어나는데',purpose:'늘어나려고',result:'늘어나서 그렇게 되다'}},
      {ko:'늦다', ro:'a fi târziu', en:'to be late', aliases:['e târziu','fi târziu','be late'], final:'늦어요', forms:{none:'늦어요',seq:'늦고',cause1:'늦어서',cause2:'늦으니까',condition:'늦으면',contrast1:'늦지만',contrast2:'늦는데',purpose:'늦으려고',result:'늦어서 그렇게 되다'}},
      {ko:'늦잠을 자다', ro:'a dormi prea mult', en:'to oversleep', aliases:['doarme prea mult','dormi prea mult','oversleep'], final:'늦잠을 자요', forms:{none:'늦잠을 자요',seq:'늦잠을 자고',cause1:'늦잠을 자서',cause2:'늦잠을 자니까',condition:'늦잠을 자면',contrast1:'늦잠을 자지만',contrast2:'늦잠을 자는데',purpose:'늦잠을 자려고',result:'늦잠을 자서 그렇게 되다'}},
      {ko:'다가오다', ro:'a se apropia', en:'to approach, to come closer', aliases:['se apropie','apropia','approach','come closer'], final:'다가와요', forms:{none:'다가와요',seq:'다가오고',cause1:'다가와서',cause2:'다가오니까',condition:'다가오면',contrast1:'다가오지만',contrast2:'다가오는데',purpose:'다가오려고',result:'다가와서 그렇게 되다'}},
      {ko:'다니다', ro:'a frecventa, a merge regulat (la)', en:'to attend, to commute to', aliases:['frecventează','frecventa','merge regulat','attend','commute to'], final:'다녀요', forms:{none:'다녀요',seq:'다니고',cause1:'다녀서',cause2:'다니니까',condition:'다니면',contrast1:'다니지만',contrast2:'다니는데',purpose:'다니려고',result:'다녀서 그렇게 되다'}},
      {ko:'다운로드하다', ro:'a descărca', en:'to download', aliases:['descarcă','descărca','download'], final:'다운로드해요', forms:{none:'다운로드해요',seq:'다운로드하고',cause1:'다운로드해서',cause2:'다운로드하니까',condition:'다운로드하면',contrast1:'다운로드하지만',contrast2:'다운로드하는데',purpose:'다운로드하려고',result:'다운로드해서 그렇게 되다'}},
      {ko:'다치다', ro:'a se răni', en:'to get hurt, to be injured', aliases:['se rănește','răni','get hurt','be injured'], final:'다쳐요', forms:{none:'다쳐요',seq:'다치고',cause1:'다쳐서',cause2:'다치니까',condition:'다치면',contrast1:'다치지만',contrast2:'다치는데',purpose:'다치려고',result:'다쳐서 그렇게 되다'}},
      {ko:'닦다', ro:'a șterge / a curăța', en:'to wipe / to clean', aliases:['șterge','curăța','wipe','clean'], final:'닦아요', forms:{none:'닦아요',seq:'닦고',cause1:'닦아서',cause2:'닦으니까',condition:'닦으면',contrast1:'닦지만',contrast2:'닦는데',purpose:'닦으려고',result:'닦아서 그렇게 되다'}},
      {ko:'닫히다', ro:'a se închide', en:'to close (intransitive)', aliases:['se închide','închide','close'], final:'닫혀요', forms:{none:'닫혀요',seq:'닫히고',cause1:'닫혀서',cause2:'닫히니까',condition:'닫히면',contrast1:'닫히지만',contrast2:'닫히는데',purpose:'닫히려고',result:'닫혀서 그렇게 되다'}},
      {ko:'당기다', ro:'a trage', en:'to pull', aliases:['trage','pull'], final:'당겨요', forms:{none:'당겨요',seq:'당기고',cause1:'당겨서',cause2:'당기니까',condition:'당기면',contrast1:'당기지만',contrast2:'당기는데',purpose:'당기려고',result:'당겨서 그렇게 되다'}},
      {ko:'대답하다', ro:'a răspunde', en:'to answer, to reply', aliases:['răspunde','answer','reply'], final:'대답해요', forms:{none:'대답해요',seq:'대답하고',cause1:'대답해서',cause2:'대답하니까',condition:'대답하면',contrast1:'대답하지만',contrast2:'대답하는데',purpose:'대답하려고',result:'대답해서 그렇게 되다'}},
      {ko:'더워지다', ro:'a deveni cald', en:'to become hot', aliases:['devine cald','deveni cald','become hot'], final:'더워져요', forms:{none:'더워져요',seq:'더워지고',cause1:'더워져서',cause2:'더워지니까',condition:'더워지면',contrast1:'더워지지만',contrast2:'더워지는데',purpose:'더워지려고',result:'더워져서 그렇게 되다'}},
      {ko:'던지다', ro:'a arunca', en:'to throw', aliases:['aruncă','arunca','throw'], final:'던져요', forms:{none:'던져요',seq:'던지고',cause1:'던져서',cause2:'던지니까',condition:'던지면',contrast1:'던지지만',contrast2:'던지는데',purpose:'던지려고',result:'던져서 그렇게 되다'}},
      {ko:'덮다', ro:'a acoperi', en:'to cover', aliases:['acoperă','acoperi','cover'], final:'덮어요', forms:{none:'덮어요',seq:'덮고',cause1:'덮어서',cause2:'덮으니까',condition:'덮으면',contrast1:'덮지만',contrast2:'덮는데',purpose:'덮으려고',result:'덮어서 그렇게 되다'}},
      {ko:'덮이다', ro:'a fi acoperit', en:'to be covered', aliases:['e acoperit','fi acoperit','be covered'], final:'덮여요', forms:{none:'덮여요',seq:'덮이고',cause1:'덮여서',cause2:'덮이니까',condition:'덮이면',contrast1:'덮이지만',contrast2:'덮이는데',purpose:'덮이려고',result:'덮여서 그렇게 되다'}},
      {ko:'도서관에 가다', ro:'a merge la bibliotecă', en:'to go to the library', aliases:['merge la bibliotecă','go to the library'], final:'도서관에 가요', forms:{none:'도서관에 가요',seq:'도서관에 가고',cause1:'도서관에 가서',cause2:'도서관에 가니까',condition:'도서관에 가면',contrast1:'도서관에 가지만',contrast2:'도서관에 가는데',purpose:'도서관에 가려고',result:'도서관에 가서 그렇게 되다'}},
      {ko:'돌아가다', ro:'a merge înapoi', en:'to go back, to return', aliases:['merge înapoi','go back','return'], final:'돌아가요', forms:{none:'돌아가요',seq:'돌아가고',cause1:'돌아가서',cause2:'돌아가니까',condition:'돌아가면',contrast1:'돌아가지만',contrast2:'돌아가는데',purpose:'돌아가려고',result:'돌아가서 그렇게 되다'}},
      {ko:'두다', ro:'a lăsa / a pune', en:'to leave / to put', aliases:['lasă','lăsa','pune','leave','put'], final:'둬요', forms:{none:'둬요',seq:'두고',cause1:'둬서',cause2:'두니까',condition:'두면',contrast1:'두지만',contrast2:'두는데',purpose:'두려고',result:'둬서 그렇게 되다'}},
      {ko:'드시다', ro:'a mânca (onorific)', en:'to eat (honorific)', aliases:['mănâncă','mânca','eat'], final:'드셔요', forms:{none:'드셔요',seq:'드시고',cause1:'드셔서',cause2:'드시니까',condition:'드시면',contrast1:'드시지만',contrast2:'드시는데',purpose:'드시려고',result:'드셔서 그렇게 되다'}},
      {ko:'들다', ro:'a ridica, a ține', en:'to lift, to hold', aliases:['ridică','ridica','ține','lift','hold'], final:'들어요', forms:{none:'들어요',seq:'들고',cause1:'들어서',cause2:'들니까',condition:'들면',contrast1:'들지만',contrast2:'들는데',purpose:'들려고',result:'들어서 그렇게 되다'}},
      {ko:'들르다', ro:'a trece pe la, a face o oprire', en:'to stop by', aliases:['trece pe la','face o oprire','stop by'], final:'들러요', forms:{none:'들러요',seq:'들르고',cause1:'들러서',cause2:'들르니까',condition:'들르면',contrast1:'들르지만',contrast2:'들르는데',purpose:'들르려고',result:'들러서 그렇게 되다'}},
      {ko:'들리다', ro:'a se auzi', en:'to be heard, to sound', aliases:['se aude','auzi','be heard','sound'], final:'들려요', forms:{none:'들려요',seq:'들리고',cause1:'들려서',cause2:'들리니까',condition:'들리면',contrast1:'들리지만',contrast2:'들리는데',purpose:'들리려고',result:'들려서 그렇게 되다'}},
      {ko:'들어가다', ro:'a intra', en:'to go in, to enter', aliases:['intră','intra','go in','enter'], final:'들어가요', forms:{none:'들어가요',seq:'들어가고',cause1:'들어가서',cause2:'들어가니까',condition:'들어가면',contrast1:'들어가지만',contrast2:'들어가는데',purpose:'들어가려고',result:'들어가서 그렇게 되다'}},
      {ko:'등록하다', ro:'a înregistra, a se înscrie', en:'to register', aliases:['înregistrează','înregistra','înscrie','register'], final:'등록해요', forms:{none:'등록해요',seq:'등록하고',cause1:'등록해서',cause2:'등록하니까',condition:'등록하면',contrast1:'등록하지만',contrast2:'등록하는데',purpose:'등록하려고',result:'등록해서 그렇게 되다'}},
      {ko:'따르다', ro:'a urma, a turna', en:'to follow, to pour', aliases:['urmează','urma','turna','follow','pour'], final:'따라요', forms:{none:'따라요',seq:'따르고',cause1:'따라서',cause2:'따르니까',condition:'따르면',contrast1:'따르지만',contrast2:'따르는데',purpose:'따르려고',result:'따라서 그렇게 되다'}},
      {ko:'땀이 나다', ro:'a transpira', en:'to sweat', aliases:['transpiră','transpira','sweat'], final:'땀이 나요', forms:{none:'땀이 나요',seq:'땀이 나고',cause1:'땀이 나서',cause2:'땀이 나니까',condition:'땀이 나면',contrast1:'땀이 나지만',contrast2:'땀이 나는데',purpose:'땀이 나려고',result:'땀이 나서 그렇게 되다'}},
      {ko:'떨어지다', ro:'a cădea, a se termina', en:'to fall, to run out', aliases:['cade','cădea','termina','fall','run out'], final:'떨어져요', forms:{none:'떨어져요',seq:'떨어지고',cause1:'떨어져서',cause2:'떨어지니까',condition:'떨어지면',contrast1:'떨어지지만',contrast2:'떨어지는데',purpose:'떨어지려고',result:'떨어져서 그렇게 되다'}},
      {ko:'뛰다', ro:'a alerga / a sări', en:'to run / to jump', aliases:['aleargă','alerga','sări','run','jump'], final:'뛰어요', forms:{none:'뛰어요',seq:'뛰고',cause1:'뛰어서',cause2:'뛰니까',condition:'뛰면',contrast1:'뛰지만',contrast2:'뛰는데',purpose:'뛰려고',result:'뛰어서 그렇게 되다'}},
      {ko:'뜨다', ro:'a deschide (ochii), a pluti', en:'to open (eyes), to float', aliases:['deschide','pluti','open','float'], final:'떠요', forms:{none:'떠요',seq:'뜨고',cause1:'떠서',cause2:'뜨니까',condition:'뜨면',contrast1:'뜨지만',contrast2:'뜨는데',purpose:'뜨려고',result:'떠서 그렇게 되다'}},
      {ko:'로그아웃하다', ro:'a se deconecta', en:'to log out', aliases:['se deconectează','deconecta','log out'], final:'로그아웃해요', forms:{none:'로그아웃해요',seq:'로그아웃하고',cause1:'로그아웃해서',cause2:'로그아웃하니까',condition:'로그아웃하면',contrast1:'로그아웃하지만',contrast2:'로그아웃하는데',purpose:'로그아웃하려고',result:'로그아웃해서 그렇게 되다'}},
      {ko:'로그인하다', ro:'a se autentifica', en:'to log in', aliases:['se autentifică','autentifica','log in'], final:'로그인해요', forms:{none:'로그인해요',seq:'로그인하고',cause1:'로그인해서',cause2:'로그인하니까',condition:'로그인하면',contrast1:'로그인하지만',contrast2:'로그인하는데',purpose:'로그인하려고',result:'로그인해서 그렇게 되다'}},
      {ko:'마음에 들다', ro:'a-ți plăcea', en:'to like, to appeal to you', aliases:['îți place','plăcea','like','appeal to you'], final:'마음에 들어요', forms:{none:'마음에 들어요',seq:'마음에 들고',cause1:'마음에 들어서',cause2:'마음에 들니까',condition:'마음에 들면',contrast1:'마음에 들지만',contrast2:'마음에 들는데',purpose:'마음에 들려고',result:'마음에 들어서 그렇게 되다'}},
      {ko:'마주치다', ro:'a se întâlni (privirile), a da nas în nas', en:'to encounter, to meet (eyes)', aliases:['se întâlnește','întâlni','da nas în nas','encounter','meet'], final:'마주쳐요', forms:{none:'마주쳐요',seq:'마주치고',cause1:'마주쳐서',cause2:'마주치니까',condition:'마주치면',contrast1:'마주치지만',contrast2:'마주치는데',purpose:'마주치려고',result:'마주쳐서 그렇게 되다'}},
      {ko:'막히다', ro:'a fi blocat', en:'to be blocked, to be stuck', aliases:['e blocat','fi blocat','be blocked','be stuck'], final:'막혀요', forms:{none:'막혀요',seq:'막히고',cause1:'막혀서',cause2:'막히니까',condition:'막히면',contrast1:'막히지만',contrast2:'막히는데',purpose:'막히려고',result:'막혀서 그렇게 되다'}},
      {ko:'만족하다', ro:'a fi mulțumit', en:'to be satisfied', aliases:['e mulțumit','fi mulțumit','be satisfied'], final:'만족해요', forms:{none:'만족해요',seq:'만족하고',cause1:'만족해서',cause2:'만족하니까',condition:'만족하면',contrast1:'만족하지만',contrast2:'만족하는데',purpose:'만족하려고',result:'만족해서 그렇게 되다'}},
      {ko:'망가지다', ro:'a se strica, a se rupe', en:'to break down, to get damaged', aliases:['se strică','strica','rupe','break down','get damaged'], final:'망가져요', forms:{none:'망가져요',seq:'망가지고',cause1:'망가져서',cause2:'망가지니까',condition:'망가지면',contrast1:'망가지지만',contrast2:'망가지는데',purpose:'망가지려고',result:'망가져서 그렇게 되다'}},
      {ko:'맡다', ro:'a prelua, a fi responsabil', en:'to take charge of, to be in charge', aliases:['preia','prelua','fi responsabil','take charge of','be in charge'], final:'맡아요', forms:{none:'맡아요',seq:'맡고',cause1:'맡아서',cause2:'맡으니까',condition:'맡으면',contrast1:'맡지만',contrast2:'맡는데',purpose:'맡으려고',result:'맡아서 그렇게 되다'}},
      {ko:'매다', ro:'a lega / a purta (curea)', en:'to tie / to wear (belt)', aliases:['leagă','lega','purta','tie','wear'], final:'매어요', forms:{none:'매어요',seq:'매고',cause1:'매어서',cause2:'매니까',condition:'매면',contrast1:'매지만',contrast2:'매는데',purpose:'매려고',result:'매어서 그렇게 되다'}},
      {ko:'면도하다', ro:'a se bărbieri', en:'to shave', aliases:['se bărbierește','bărbieri','shave'], final:'면도해요', forms:{none:'면도해요',seq:'면도하고',cause1:'면도해서',cause2:'면도하니까',condition:'면도하면',contrast1:'면도하지만',contrast2:'면도하는데',purpose:'면도하려고',result:'면도해서 그렇게 되다'}},
      {ko:'모르다', ro:'a nu ști', en:'to not know', aliases:['nu știe','ști','not know'], final:'몰라요', forms:{none:'몰라요',seq:'모르고',cause1:'몰라서',cause2:'모르니까',condition:'모르면',contrast1:'모르지만',contrast2:'모르는데',purpose:'모르려고',result:'몰라서 그렇게 되다'}},
      {ko:'모이다', ro:'a se aduna', en:'to gather, to assemble', aliases:['se adună','aduna','gather','assemble'], final:'모여요', forms:{none:'모여요',seq:'모이고',cause1:'모여서',cause2:'모이니까',condition:'모이면',contrast1:'모이지만',contrast2:'모이는데',purpose:'모이려고',result:'모여서 그렇게 되다'}},
      {ko:'문지르다', ro:'a freca, a masa', en:'to rub', aliases:['freacă','freca','masa','rub'], final:'문질러요', forms:{none:'문질러요',seq:'문지르고',cause1:'문질러서',cause2:'문지르니까',condition:'문지르면',contrast1:'문지르지만',contrast2:'문지르는데',purpose:'문지르려고',result:'문질러서 그렇게 되다'}},
      {ko:'물놀이하다', ro:'a se juca în apă', en:'to play in the water', aliases:['se joacă în apă','juca în apă','play in the water'], final:'물놀이해요', forms:{none:'물놀이해요',seq:'물놀이하고',cause1:'물놀이해서',cause2:'물놀이하니까',condition:'물놀이하면',contrast1:'물놀이하지만',contrast2:'물놀이하는데',purpose:'물놀이하려고',result:'물놀이해서 그렇게 되다'}},
      {ko:'물어보다', ro:'a întreba', en:'to ask a question', aliases:['întreabă','întreba','ask a question'], final:'물어봐요', forms:{none:'물어봐요',seq:'물어보고',cause1:'물어봐서',cause2:'물어보니까',condition:'물어보면',contrast1:'물어보지만',contrast2:'물어보는데',purpose:'물어보려고',result:'물어봐서 그렇게 되다'}},
      {ko:'믿다', ro:'a crede, a avea încredere', en:'to believe, to trust', aliases:['crede','avea încredere','believe','trust'], final:'믿어요', forms:{none:'믿어요',seq:'믿고',cause1:'믿어서',cause2:'믿으니까',condition:'믿으면',contrast1:'믿지만',contrast2:'믿는데',purpose:'믿으려고',result:'믿어서 그렇게 되다'}},
      {ko:'밀다', ro:'a împinge', en:'to push', aliases:['împinge','push'], final:'밀어요', forms:{none:'밀어요',seq:'밀고',cause1:'밀어서',cause2:'밀니까',condition:'밀면',contrast1:'밀지만',contrast2:'밀는데',purpose:'밀려고',result:'밀어서 그렇게 되다'}},
      {ko:'반복하다', ro:'a repeta', en:'to repeat', aliases:['repetă','repeta','repeat'], final:'반복해요', forms:{none:'반복해요',seq:'반복하고',cause1:'반복해서',cause2:'반복하니까',condition:'반복하면',contrast1:'반복하지만',contrast2:'반복하는데',purpose:'반복하려고',result:'반복해서 그렇게 되다'}},
      {ko:'발견하다', ro:'a descoperi', en:'to discover', aliases:['descoperă','descoperi','discover'], final:'발견해요', forms:{none:'발견해요',seq:'발견하고',cause1:'발견해서',cause2:'발견하니까',condition:'발견하면',contrast1:'발견하지만',contrast2:'발견하는데',purpose:'발견하려고',result:'발견해서 그렇게 되다'}},
      {ko:'방문하다', ro:'a vizita', en:'to visit', aliases:['vizitează','vizita','visit'], final:'방문해요', forms:{none:'방문해요',seq:'방문하고',cause1:'방문해서',cause2:'방문하니까',condition:'방문하면',contrast1:'방문하지만',contrast2:'방문하는데',purpose:'방문하려고',result:'방문해서 그렇게 되다'}},
      {ko:'배가 고프다', ro:'a fi flămând', en:'to be hungry', aliases:['e flămând','fi flămând','be hungry'], final:'배가 고파요', forms:{none:'배가 고파요',seq:'배가 고프고',cause1:'배가 고파서',cause2:'배가 고프니까',condition:'배가 고프면',contrast1:'배가 고프지만',contrast2:'배가 고프는데',purpose:'배가 고프려고',result:'배가 고파서 그렇게 되다'}},
      {ko:'배달하다', ro:'a livra', en:'to deliver', aliases:['livrează','livra','deliver'], final:'배달해요', forms:{none:'배달해요',seq:'배달하고',cause1:'배달해서',cause2:'배달하니까',condition:'배달하면',contrast1:'배달하지만',contrast2:'배달하는데',purpose:'배달하려고',result:'배달해서 그렇게 되다'}},
      {ko:'버리다', ro:'a arunca', en:'to throw away, to discard', aliases:['aruncă','arunca','throw away','discard'], final:'버려요', forms:{none:'버려요',seq:'버리고',cause1:'버려서',cause2:'버리니까',condition:'버리면',contrast1:'버리지만',contrast2:'버리는데',purpose:'버리려고',result:'버려서 그렇게 되다'}},
      {ko:'벗다', ro:'a se dezbrăca', en:'to take off (clothes)', aliases:['se dezbracă','dezbrăca','take off'], final:'벗어요', forms:{none:'벗어요',seq:'벗고',cause1:'벗어서',cause2:'벗으니까',condition:'벗으면',contrast1:'벗지만',contrast2:'벗는데',purpose:'벗으려고',result:'벗어서 그렇게 되다'}},
      {ko:'벗어나다', ro:'a scăpa / a ieși din', en:'to escape / get out of', aliases:['scapă','scăpa','ieși din','escape','get out of'], final:'벗어나요', forms:{none:'벗어나요',seq:'벗어나고',cause1:'벗어나서',cause2:'벗어나니까',condition:'벗어나면',contrast1:'벗어나지만',contrast2:'벗어나는데',purpose:'벗어나려고',result:'벗어나서 그렇게 되다'}},
      {ko:'변하다', ro:'a deveni', en:'to become', aliases:['devine','deveni','become'], final:'변해요', forms:{none:'변해요',seq:'변하고',cause1:'변해서',cause2:'변하니까',condition:'변하면',contrast1:'변하지만',contrast2:'변하는데',purpose:'변하려고',result:'변해서 그렇게 되다'}},
      {ko:'보살피다', ro:'a îngriji, a veghea', en:'to take care of, to look after', aliases:['îngrijește','îngriji','veghea','take care of','look after'], final:'보살펴요', forms:{none:'보살펴요',seq:'보살피고',cause1:'보살펴서',cause2:'보살피니까',condition:'보살피면',contrast1:'보살피지만',contrast2:'보살피는데',purpose:'보살피려고',result:'보살펴서 그렇게 되다'}},
      {ko:'보이다', ro:'a se vedea, a părea', en:'to be seen, to seem', aliases:['se vede','vedea','părea','be seen','seem'], final:'보여요', forms:{none:'보여요',seq:'보이고',cause1:'보여서',cause2:'보이니까',condition:'보이면',contrast1:'보이지만',contrast2:'보이는데',purpose:'보이려고',result:'보여서 그렇게 되다'}},
      {ko:'보호하다', ro:'a proteja', en:'to protect', aliases:['protejează','proteja','protect'], final:'보호해요', forms:{none:'보호해요',seq:'보호하고',cause1:'보호해서',cause2:'보호하니까',condition:'보호하면',contrast1:'보호하지만',contrast2:'보호하는데',purpose:'보호하려고',result:'보호해서 그렇게 되다'}},
      {ko:'부딪히다', ro:'a se ciocni', en:'to collide / bump into', aliases:['se ciocnește','ciocni','collide','bump into'], final:'부딪혀요', forms:{none:'부딪혀요',seq:'부딪히고',cause1:'부딪혀서',cause2:'부딪히니까',condition:'부딪히면',contrast1:'부딪히지만',contrast2:'부딪히는데',purpose:'부딪히려고',result:'부딪혀서 그렇게 되다'}},
      {ko:'부르다', ro:'a cânta, a striga', en:'to sing, to call', aliases:['cântă','cânta','striga','sing','call'], final:'불러요', forms:{none:'불러요',seq:'부르고',cause1:'불러서',cause2:'부르니까',condition:'부르면',contrast1:'부르지만',contrast2:'부르는데',purpose:'부르려고',result:'불러서 그렇게 되다'}},
      {ko:'부탁하다', ro:'a ruga, a cere un favor', en:'to ask a favor', aliases:['roagă','ruga','cere un favor','ask a favor'], final:'부탁해요', forms:{none:'부탁해요',seq:'부탁하고',cause1:'부탁해서',cause2:'부탁하니까',condition:'부탁하면',contrast1:'부탁하지만',contrast2:'부탁하는데',purpose:'부탁하려고',result:'부탁해서 그렇게 되다'}},
      {ko:'분석하다', ro:'a analiza', en:'to analyze', aliases:['analizează','analiza','analyze'], final:'분석해요', forms:{none:'분석해요',seq:'분석하고',cause1:'분석해서',cause2:'분석하니까',condition:'분석하면',contrast1:'분석하지만',contrast2:'분석하는데',purpose:'분석하려고',result:'분석해서 그렇게 되다'}},
      {ko:'비가 오다', ro:'a ploua', en:'to rain', aliases:['plouă','ploua','rain'], final:'비가 와요', forms:{none:'비가 와요',seq:'비가 오고',cause1:'비가 와서',cause2:'비가 오니까',condition:'비가 오면',contrast1:'비가 오지만',contrast2:'비가 오는데',purpose:'비가 오려고',result:'비가 와서 그렇게 되다'}},
      {ko:'비교하다', ro:'a compara', en:'to compare', aliases:['compară','compara','compare'], final:'비교해요', forms:{none:'비교해요',seq:'비교하고',cause1:'비교해서',cause2:'비교하니까',condition:'비교하면',contrast1:'비교하지만',contrast2:'비교하는데',purpose:'비교하려고',result:'비교해서 그렇게 되다'}},
      {ko:'비행기를 타다', ro:'a lua avionul', en:'to board the plane', aliases:['ia avionul','lua avionul','board the plane'], final:'비행기를 타요', forms:{none:'비행기를 타요',seq:'비행기를 타고',cause1:'비행기를 타서',cause2:'비행기를 타니까',condition:'비행기를 타면',contrast1:'비행기를 타지만',contrast2:'비행기를 타는데',purpose:'비행기를 타려고',result:'비행기를 타서 그렇게 되다'}},
      {ko:'빌려주다', ro:'a împrumuta (cuiva)', en:'to lend', aliases:['împrumută','împrumuta','lend'], final:'빌려줘요', forms:{none:'빌려줘요',seq:'빌려주고',cause1:'빌려줘서',cause2:'빌려주니까',condition:'빌려주면',contrast1:'빌려주지만',contrast2:'빌려주는데',purpose:'빌려주려고',result:'빌려줘서 그렇게 되다'}},
      {ko:'빨래하다', ro:'a spăla rufe', en:'to do laundry', aliases:['spală rufe','spăla rufe','do laundry'], final:'빨래해요', forms:{none:'빨래해요',seq:'빨래하고',cause1:'빨래해서',cause2:'빨래하니까',condition:'빨래하면',contrast1:'빨래하지만',contrast2:'빨래하는데',purpose:'빨래하려고',result:'빨래해서 그렇게 되다'}},
      {ko:'빼다', ro:'a scoate / a scădea', en:'to remove / to subtract', aliases:['scoate','scădea','remove','subtract'], final:'빼어요', forms:{none:'빼어요',seq:'빼고',cause1:'빼어서',cause2:'빼니까',condition:'빼면',contrast1:'빼지만',contrast2:'빼는데',purpose:'빼려고',result:'빼어서 그렇게 되다'}},
      {ko:'사과하다', ro:'a-și cere scuze', en:'to apologize', aliases:['își cere scuze','cere scuze','apologize'], final:'사과해요', forms:{none:'사과해요',seq:'사과하고',cause1:'사과해서',cause2:'사과하니까',condition:'사과하면',contrast1:'사과하지만',contrast2:'사과하는데',purpose:'사과하려고',result:'사과해서 그렇게 되다'}},
      {ko:'사귀다', ro:'a se împrieteni, a fi într-o relație', en:'to date, to make friends', aliases:['se împrietenește','împrieteni','fi într-o relație','date','make friends'], final:'사귀어요', forms:{none:'사귀어요',seq:'사귀고',cause1:'사귀어서',cause2:'사귀니까',condition:'사귀면',contrast1:'사귀지만',contrast2:'사귀는데',purpose:'사귀려고',result:'사귀어서 그렇게 되다'}},
      {ko:'사라지다', ro:'a dispărea', en:'to disappear', aliases:['dispare','dispărea','disappear'], final:'사라져요', forms:{none:'사라져요',seq:'사라지고',cause1:'사라져서',cause2:'사라지니까',condition:'사라지면',contrast1:'사라지지만',contrast2:'사라지는데',purpose:'사라지려고',result:'사라져서 그렇게 되다'}},
      {ko:'살다', ro:'a trăi', en:'to live', aliases:['trăiește','trăi','live'], final:'살아요', forms:{none:'살아요',seq:'살고',cause1:'살아서',cause2:'사니까',condition:'살면',contrast1:'살지만',contrast2:'사는데',purpose:'살려고',result:'살아서 그렇게 되다'}},
      {ko:'상상하다', ro:'a-și imagina', en:'to imagine', aliases:['își imaginează','imagina','imagine'], final:'상상해요', forms:{none:'상상해요',seq:'상상하고',cause1:'상상해서',cause2:'상상하니까',condition:'상상하면',contrast1:'상상하지만',contrast2:'상상하는데',purpose:'상상하려고',result:'상상해서 그렇게 되다'}},
      {ko:'생기다', ro:'a apărea, a lua ființă', en:'to arise, to come into existence', aliases:['apare','apărea','lua ființă','arise','come into existence'], final:'생겨요', forms:{none:'생겨요',seq:'생기고',cause1:'생겨서',cause2:'생기니까',condition:'생기면',contrast1:'생기지만',contrast2:'생기는데',purpose:'생기려고',result:'생겨서 그렇게 되다'}},
      {ko:'샤워하다', ro:'a face duș', en:'to take a shower', aliases:['face duș','take a shower'], final:'샤워해요', forms:{none:'샤워해요',seq:'샤워하고',cause1:'샤워해서',cause2:'샤워하니까',condition:'샤워하면',contrast1:'샤워하지만',contrast2:'샤워하는데',purpose:'샤워하려고',result:'샤워해서 그렇게 되다'}},
      {ko:'서다', ro:'a sta în picioare', en:'to stand', aliases:['stă în picioare','sta în picioare','stand'], final:'서어요', forms:{none:'서어요',seq:'서고',cause1:'서어서',cause2:'서니까',condition:'서면',contrast1:'서지만',contrast2:'서는데',purpose:'서려고',result:'서어서 그렇게 되다'}},
      {ko:'섞다', ro:'a amesteca', en:'to mix', aliases:['amestecă','amesteca','mix'], final:'섞어요', forms:{none:'섞어요',seq:'섞고',cause1:'섞어서',cause2:'섞으니까',condition:'섞으면',contrast1:'섞지만',contrast2:'섞는데',purpose:'섞으려고',result:'섞어서 그렇게 되다'}},
      {ko:'설치하다', ro:'a instala', en:'to install', aliases:['instalează','instala','install'], final:'설치해요', forms:{none:'설치해요',seq:'설치하고',cause1:'설치해서',cause2:'설치하니까',condition:'설치하면',contrast1:'설치하지만',contrast2:'설치하는데',purpose:'설치하려고',result:'설치해서 그렇게 되다'}},
      {ko:'소개하다', ro:'a prezenta, a introduce', en:'to introduce', aliases:['prezintă','prezenta','introduce'], final:'소개해요', forms:{none:'소개해요',seq:'소개하고',cause1:'소개해서',cause2:'소개하니까',condition:'소개하면',contrast1:'소개하지만',contrast2:'소개하는데',purpose:'소개하려고',result:'소개해서 그렇게 되다'}},
      {ko:'쇼핑하다', ro:'a face cumpărături', en:'to go shopping', aliases:['face cumpărături','go shopping'], final:'쇼핑해요', forms:{none:'쇼핑해요',seq:'쇼핑하고',cause1:'쇼핑해서',cause2:'쇼핑하니까',condition:'쇼핑하면',contrast1:'쇼핑하지만',contrast2:'쇼핑하는데',purpose:'쇼핑하려고',result:'쇼핑해서 그렇게 되다'}},
      {ko:'수속하다', ro:'a face check-in', en:'to check in', aliases:['face check-in','check in'], final:'수속해요', forms:{none:'수속해요',seq:'수속하고',cause1:'수속해서',cause2:'수속하니까',condition:'수속하면',contrast1:'수속하지만',contrast2:'수속하는데',purpose:'수속하려고',result:'수속해서 그렇게 되다'}},
      {ko:'수영하다', ro:'a înota', en:'to swim', aliases:['înoată','înota','swim'], final:'수영해요', forms:{none:'수영해요',seq:'수영하고',cause1:'수영해서',cause2:'수영하니까',condition:'수영하면',contrast1:'수영하지만',contrast2:'수영하는데',purpose:'수영하려고',result:'수영해서 그렇게 되다'}},
      {ko:'숨다', ro:'a se ascunde', en:'to hide', aliases:['se ascunde','ascunde','hide'], final:'숨어요', forms:{none:'숨어요',seq:'숨고',cause1:'숨어서',cause2:'숨으니까',condition:'숨으면',contrast1:'숨지만',contrast2:'숨는데',purpose:'숨으려고',result:'숨어서 그렇게 되다'}},
      {ko:'시도하다', ro:'a încerca', en:'to attempt', aliases:['încearcă','încerca','attempt'], final:'시도해요', forms:{none:'시도해요',seq:'시도하고',cause1:'시도해서',cause2:'시도하니까',condition:'시도하면',contrast1:'시도하지만',contrast2:'시도하는데',purpose:'시도하려고',result:'시도해서 그렇게 되다'}},
      {ko:'시작하다', ro:'a începe', en:'to start', aliases:['începe','start'], final:'시작해요', forms:{none:'시작해요',seq:'시작하고',cause1:'시작해서',cause2:'시작하니까',condition:'시작하면',contrast1:'시작하지만',contrast2:'시작하는데',purpose:'시작하려고',result:'시작해서 그렇게 되다'}},
      {ko:'시키다', ro:'a comanda / a pune pe cineva să facă', en:'to order / to make someone do', aliases:['comandă','comanda','pune pe cineva să facă','order','make someone do'], final:'시켜요', forms:{none:'시켜요',seq:'시키고',cause1:'시켜서',cause2:'시키니까',condition:'시키면',contrast1:'시키지만',contrast2:'시키는데',purpose:'시키려고',result:'시켜서 그렇게 되다'}},
      {ko:'시험이 있다', ro:'a fi examen', en:'to have an exam', aliases:['e examen','fi examen','have an exam'], final:'시험이 있어요', forms:{none:'시험이 있어요',seq:'시험이 있고',cause1:'시험이 있어서',cause2:'시험이 있으니까',condition:'시험이 있으면',contrast1:'시험이 있지만',contrast2:'시험이 있는데',purpose:'시험이 있으려고',result:'시험이 있어서 그렇게 되다'}},
      {ko:'신다', ro:'a încălța', en:'to put on footwear', aliases:['încalță','încălța','put on footwear'], final:'신어요', forms:{none:'신어요',seq:'신고',cause1:'신어서',cause2:'신으니까',condition:'신으면',contrast1:'신지만',contrast2:'신는데',purpose:'신으려고',result:'신어서 그렇게 되다'}},
      {ko:'실망하다', ro:'a fi dezamăgit', en:'to be disappointed', aliases:['e dezamăgit','fi dezamăgit','be disappointed'], final:'실망해요', forms:{none:'실망해요',seq:'실망하고',cause1:'실망해서',cause2:'실망하니까',condition:'실망하면',contrast1:'실망하지만',contrast2:'실망하는데',purpose:'실망하려고',result:'실망해서 그렇게 되다'}},
      {ko:'싸우다', ro:'a se certa, a se lupta', en:'to fight, to argue', aliases:['se ceartă','certa','lupta','fight','argue'], final:'싸워요', forms:{none:'싸워요',seq:'싸우고',cause1:'싸워서',cause2:'싸우니까',condition:'싸우면',contrast1:'싸우지만',contrast2:'싸우는데',purpose:'싸우려고',result:'싸워서 그렇게 되다'}},
      {ko:'쌓이다', ro:'a se aduna, a se depune', en:'to pile up, accumulate', aliases:['se adună','aduna','depune','pile up','accumulate'], final:'쌓여요', forms:{none:'쌓여요',seq:'쌓이고',cause1:'쌓여서',cause2:'쌓이니까',condition:'쌓이면',contrast1:'쌓이지만',contrast2:'쌓이는데',purpose:'쌓이려고',result:'쌓여서 그렇게 되다'}},
      {ko:'쓰러지다', ro:'a cădea, a leșina', en:'to collapse, to faint', aliases:['cade','cădea','leșina','collapse','faint'], final:'쓰러져요', forms:{none:'쓰러져요',seq:'쓰러지고',cause1:'쓰러져서',cause2:'쓰러지니까',condition:'쓰러지면',contrast1:'쓰러지지만',contrast2:'쓰러지는데',purpose:'쓰러지려고',result:'쓰러져서 그렇게 되다'}},
      {ko:'안심하다', ro:'a se liniști', en:'to feel relieved', aliases:['se liniștește','liniști','feel relieved'], final:'안심해요', forms:{none:'안심해요',seq:'안심하고',cause1:'안심해서',cause2:'안심하니까',condition:'안심하면',contrast1:'안심하지만',contrast2:'안심하는데',purpose:'안심하려고',result:'안심해서 그렇게 되다'}},
      {ko:'앉다', ro:'a se așeza', en:'to sit', aliases:['se așază','așeza','sit'], final:'앉아요', forms:{none:'앉아요',seq:'앉고',cause1:'앉아서',cause2:'앉으니까',condition:'앉으면',contrast1:'앉지만',contrast2:'앉는데',purpose:'앉으려고',result:'앉아서 그렇게 되다'}},
      {ko:'알람을 맞추다', ro:'a seta alarma', en:'to set an alarm', aliases:['setează alarma','seta alarma','set an alarm'], final:'알람을 맞춰요', forms:{none:'알람을 맞춰요',seq:'알람을 맞추고',cause1:'알람을 맞춰서',cause2:'알람을 맞추니까',condition:'알람을 맞추면',contrast1:'알람을 맞추지만',contrast2:'알람을 맞추는데',purpose:'알람을 맞추려고',result:'알람을 맞춰서 그렇게 되다'}},
      {ko:'알아듣다', ro:'a înțelege (ascultând)', en:'to understand (by listening)', aliases:['înțelege','understand'], final:'알아들어요', forms:{none:'알아들어요',seq:'알아듣고',cause1:'알아들어서',cause2:'알아듣으니까',condition:'알아듣으면',contrast1:'알아듣지만',contrast2:'알아듣는데',purpose:'알아듣으려고',result:'알아들어서 그렇게 되다'}},
      {ko:'알아보다', ro:'a cerceta, a afla', en:'to find out, to look into', aliases:['cercetează','cerceta','afla','find out','look into'], final:'알아봐요', forms:{none:'알아봐요',seq:'알아보고',cause1:'알아봐서',cause2:'알아보니까',condition:'알아보면',contrast1:'알아보지만',contrast2:'알아보는데',purpose:'알아보려고',result:'알아봐서 그렇게 되다'}},
      {ko:'약속하다', ro:'a promite, a se întâlni', en:'to promise, to make an appointment', aliases:['promite','întâlni','promise','make an appointment'], final:'약속해요', forms:{none:'약속해요',seq:'약속하고',cause1:'약속해서',cause2:'약속하니까',condition:'약속하면',contrast1:'약속하지만',contrast2:'약속하는데',purpose:'약속하려고',result:'약속해서 그렇게 되다'}},
      {ko:'약을 먹다', ro:'a lua medicament', en:'to take medicine', aliases:['ia medicament','lua medicament','take medicine'], final:'약을 먹어요', forms:{none:'약을 먹어요',seq:'약을 먹고',cause1:'약을 먹어서',cause2:'약을 먹으니까',condition:'약을 먹으면',contrast1:'약을 먹지만',contrast2:'약을 먹는데',purpose:'약을 먹으려고',result:'약을 먹어서 그렇게 되다'}},
      {ko:'약을 사다', ro:'a cumpăra medicament', en:'to buy medicine', aliases:['cumpără medicament','cumpăra medicament','buy medicine'], final:'약을 사요', forms:{none:'약을 사요',seq:'약을 사고',cause1:'약을 사서',cause2:'약을 사니까',condition:'약을 사면',contrast1:'약을 사지만',contrast2:'약을 사는데',purpose:'약을 사려고',result:'약을 사서 그렇게 되다'}},
      {ko:'어울리다', ro:'a se potrivi', en:'to suit, to match, to fit', aliases:['se potrivește','potrivi','suit','match','fit'], final:'어울려요', forms:{none:'어울려요',seq:'어울리고',cause1:'어울려서',cause2:'어울리니까',condition:'어울리면',contrast1:'어울리지만',contrast2:'어울리는데',purpose:'어울리려고',result:'어울려서 그렇게 되다'}},
      {ko:'얻다', ro:'a obține, a câștiga', en:'to obtain, to gain', aliases:['obține','câștiga','obtain','gain'], final:'얻어요', forms:{none:'얻어요',seq:'얻고',cause1:'얻어서',cause2:'얻으니까',condition:'얻으면',contrast1:'얻지만',contrast2:'얻는데',purpose:'얻으려고',result:'얻어서 그렇게 되다'}},
      {ko:'업로드하다', ro:'a încărca (online)', en:'to upload', aliases:['încarcă','încărca','upload'], final:'업로드해요', forms:{none:'업로드해요',seq:'업로드하고',cause1:'업로드해서',cause2:'업로드하니까',condition:'업로드하면',contrast1:'업로드하지만',contrast2:'업로드하는데',purpose:'업로드하려고',result:'업로드해서 그렇게 되다'}},
      {ko:'없다', ro:'a nu exista, a nu fi', en:'to not exist, to not have', aliases:['nu există','exista','fi','not exist','not have'], final:'없어요', forms:{none:'없어요',seq:'없고',cause1:'없어서',cause2:'없으니까',condition:'없으면',contrast1:'없지만',contrast2:'없는데',purpose:'없으려고',result:'없어서 그렇게 되다'}},
      {ko:'여권을 챙기다', ro:'a lua pașaportul', en:'to bring the passport', aliases:['ia pașaportul','lua pașaportul','bring the passport'], final:'여권을 챙겨요', forms:{none:'여권을 챙겨요',seq:'여권을 챙기고',cause1:'여권을 챙겨서',cause2:'여권을 챙기니까',condition:'여권을 챙기면',contrast1:'여권을 챙기지만',contrast2:'여권을 챙기는데',purpose:'여권을 챙기려고',result:'여권을 챙겨서 그렇게 되다'}},
      {ko:'연구하다', ro:'a cerceta', en:'to research', aliases:['cercetează','cerceta','research'], final:'연구해요', forms:{none:'연구해요',seq:'연구하고',cause1:'연구해서',cause2:'연구하니까',condition:'연구하면',contrast1:'연구하지만',contrast2:'연구하는데',purpose:'연구하려고',result:'연구해서 그렇게 되다'}},
      {ko:'연락하다', ro:'a contacta', en:'to contact, to get in touch', aliases:['contactează','contacta','contact','get in touch'], final:'연락해요', forms:{none:'연락해요',seq:'연락하고',cause1:'연락해서',cause2:'연락하니까',condition:'연락하면',contrast1:'연락하지만',contrast2:'연락하는데',purpose:'연락하려고',result:'연락해서 그렇게 되다'}},
      {ko:'열리다', ro:'a se deschide', en:'to open (intransitive)', aliases:['se deschide','deschide','open'], final:'열려요', forms:{none:'열려요',seq:'열리고',cause1:'열려서',cause2:'열리니까',condition:'열리면',contrast1:'열리지만',contrast2:'열리는데',purpose:'열리려고',result:'열려서 그렇게 되다'}},
      {ko:'열이 나다', ro:'a avea febră', en:'to have a fever', aliases:['are febră','avea febră','have a fever'], final:'열이 나요', forms:{none:'열이 나요',seq:'열이 나고',cause1:'열이 나서',cause2:'열이 나니까',condition:'열이 나면',contrast1:'열이 나지만',contrast2:'열이 나는데',purpose:'열이 나려고',result:'열이 나서 그렇게 되다'}},
      {ko:'영수증을 받다', ro:'a primi chitanța', en:'to get a receipt', aliases:['primește chitanța','primi chitanța','get a receipt'], final:'영수증을 받아요', forms:{none:'영수증을 받아요',seq:'영수증을 받고',cause1:'영수증을 받아서',cause2:'영수증을 받으니까',condition:'영수증을 받으면',contrast1:'영수증을 받지만',contrast2:'영수증을 받는데',purpose:'영수증을 받으려고',result:'영수증을 받아서 그렇게 되다'}},
      {ko:'영화를 보다', ro:'a viziona un film', en:'to watch a movie', aliases:['vizionează un film','viziona un film','watch a movie'], final:'영화를 봐요', forms:{none:'영화를 봐요',seq:'영화를 보고',cause1:'영화를 봐서',cause2:'영화를 보니까',condition:'영화를 보면',contrast1:'영화를 보지만',contrast2:'영화를 보는데',purpose:'영화를 보려고',result:'영화를 봐서 그렇게 되다'}},
      {ko:'예매하다', ro:'a rezerva (bilet)', en:'to book (a ticket)', aliases:['rezervă','rezerva','book'], final:'예매해요', forms:{none:'예매해요',seq:'예매하고',cause1:'예매해서',cause2:'예매하니까',condition:'예매하면',contrast1:'예매하지만',contrast2:'예매하는데',purpose:'예매하려고',result:'예매해서 그렇게 되다'}},
      {ko:'예상하다', ro:'a prevedea, a anticipa', en:'to expect, to predict', aliases:['prevede','prevedea','anticipa','expect','predict'], final:'예상해요', forms:{none:'예상해요',seq:'예상하고',cause1:'예상해서',cause2:'예상하니까',condition:'예상하면',contrast1:'예상하지만',contrast2:'예상하는데',purpose:'예상하려고',result:'예상해서 그렇게 되다'}},
      {ko:'예약하다', ro:'a rezerva', en:'to reserve, to book', aliases:['rezervă','rezerva','reserve','book'], final:'예약해요', forms:{none:'예약해요',seq:'예약하고',cause1:'예약해서',cause2:'예약하니까',condition:'예약하면',contrast1:'예약하지만',contrast2:'예약하는데',purpose:'예약하려고',result:'예약해서 그렇게 되다'}},
      {ko:'올라가다', ro:'a urca, a se ridica', en:'to go up, to climb', aliases:['urcă','urca','ridica','go up','climb'], final:'올라가요', forms:{none:'올라가요',seq:'올라가고',cause1:'올라가서',cause2:'올라가니까',condition:'올라가면',contrast1:'올라가지만',contrast2:'올라가는데',purpose:'올라가려고',result:'올라가서 그렇게 되다'}},
      {ko:'올라오다', ro:'a veni sus, a urca', en:'to come up', aliases:['vine sus','veni sus','urca','come up'], final:'올라와요', forms:{none:'올라와요',seq:'올라오고',cause1:'올라와서',cause2:'올라오니까',condition:'올라오면',contrast1:'올라오지만',contrast2:'올라오는데',purpose:'올라오려고',result:'올라와서 그렇게 되다'}},
      {ko:'올리다', ro:'a ridica, a urca', en:'to raise, to upload', aliases:['ridică','ridica','urca','raise','upload'], final:'올려요', forms:{none:'올려요',seq:'올리고',cause1:'올려서',cause2:'올리니까',condition:'올리면',contrast1:'올리지만',contrast2:'올리는데',purpose:'올리려고',result:'올려서 그렇게 되다'}},
      {ko:'완성하다', ro:'a finaliza / a completa', en:'to complete', aliases:['finalizează','finaliza','completa','complete'], final:'완성해요', forms:{none:'완성해요',seq:'완성하고',cause1:'완성해서',cause2:'완성하니까',condition:'완성하면',contrast1:'완성하지만',contrast2:'완성하는데',purpose:'완성하려고',result:'완성해서 그렇게 되다'}},
      {ko:'외출하다', ro:'a ieși afară', en:'to go out', aliases:['iese afară','ieși afară','go out'], final:'외출해요', forms:{none:'외출해요',seq:'외출하고',cause1:'외출해서',cause2:'외출하니까',condition:'외출하면',contrast1:'외출하지만',contrast2:'외출하는데',purpose:'외출하려고',result:'외출해서 그렇게 되다'}},
      {ko:'용서하다', ro:'a ierta', en:'to forgive', aliases:['iartă','ierta','forgive'], final:'용서해요', forms:{none:'용서해요',seq:'용서하고',cause1:'용서해서',cause2:'용서하니까',condition:'용서하면',contrast1:'용서하지만',contrast2:'용서하는데',purpose:'용서하려고',result:'용서해서 그렇게 되다'}},
      {ko:'우산을 챙기다', ro:'a lua umbrela cu tine', en:'to bring an umbrella', aliases:['ia umbrela cu tine','lua umbrela cu tine','bring an umbrella'], final:'우산을 챙겨요', forms:{none:'우산을 챙겨요',seq:'우산을 챙기고',cause1:'우산을 챙겨서',cause2:'우산을 챙기니까',condition:'우산을 챙기면',contrast1:'우산을 챙기지만',contrast2:'우산을 챙기는데',purpose:'우산을 챙기려고',result:'우산을 챙겨서 그렇게 되다'}},
      {ko:'운전하다', ro:'a conduce mașina', en:'to drive', aliases:['conduce mașina','drive'], final:'운전해요', forms:{none:'운전해요',seq:'운전하고',cause1:'운전해서',cause2:'운전하니까',condition:'운전하면',contrast1:'운전하지만',contrast2:'운전하는데',purpose:'운전하려고',result:'운전해서 그렇게 되다'}},
      {ko:'울리다', ro:'a suna, a face să sune', en:'to ring, to make ring', aliases:['sună','suna','face să sune','ring','make ring'], final:'울려요', forms:{none:'울려요',seq:'울리고',cause1:'울려서',cause2:'울리니까',condition:'울리면',contrast1:'울리지만',contrast2:'울리는데',purpose:'울리려고',result:'울려서 그렇게 되다'}},
      {ko:'음악을 듣다', ro:'a asculta muzică', en:'to listen to music', aliases:['ascultă muzică','asculta muzică','listen to music'], final:'음악을 들어요', forms:{none:'음악을 들어요',seq:'음악을 듣고',cause1:'음악을 들어서',cause2:'음악을 듣으니까',condition:'음악을 듣으면',contrast1:'음악을 듣지만',contrast2:'음악을 듣는데',purpose:'음악을 듣으려고',result:'음악을 들어서 그렇게 되다'}},
      {ko:'이를 닦다', ro:'a se spăla pe dinți', en:'to brush teeth', aliases:['se spală pe dinți','spăla pe dinți','brush teeth'], final:'이를 닦아요', forms:{none:'이를 닦아요',seq:'이를 닦고',cause1:'이를 닦아서',cause2:'이를 닦으니까',condition:'이를 닦으면',contrast1:'이를 닦지만',contrast2:'이를 닦는데',purpose:'이를 닦으려고',result:'이를 닦아서 그렇게 되다'}},
      {ko:'이사하다', ro:'a se muta (locuință)', en:'to move (house)', aliases:['se mută','muta','move'], final:'이사해요', forms:{none:'이사해요',seq:'이사하고',cause1:'이사해서',cause2:'이사하니까',condition:'이사하면',contrast1:'이사하지만',contrast2:'이사하는데',purpose:'이사하려고',result:'이사해서 그렇게 되다'}},
      {ko:'이야기하다', ro:'a vorbi, a conversa', en:'to talk, to chat', aliases:['vorbește','vorbi','conversa','talk','chat'], final:'이야기해요', forms:{none:'이야기해요',seq:'이야기하고',cause1:'이야기해서',cause2:'이야기하니까',condition:'이야기하면',contrast1:'이야기하지만',contrast2:'이야기하는데',purpose:'이야기하려고',result:'이야기해서 그렇게 되다'}},
      {ko:'이어지다', ro:'a continua / a se lega de', en:'to be connected / continue', aliases:['continuă','continua','lega de','be connected','continue'], final:'이어져요', forms:{none:'이어져요',seq:'이어지고',cause1:'이어져서',cause2:'이어지니까',condition:'이어지면',contrast1:'이어지지만',contrast2:'이어지는데',purpose:'이어지려고',result:'이어져서 그렇게 되다'}},
      {ko:'이혼하다', ro:'a divorța', en:'to get divorced', aliases:['divorțează','divorța','get divorced'], final:'이혼해요', forms:{none:'이혼해요',seq:'이혼하고',cause1:'이혼해서',cause2:'이혼하니까',condition:'이혼하면',contrast1:'이혼하지만',contrast2:'이혼하는데',purpose:'이혼하려고',result:'이혼해서 그렇게 되다'}},
      {ko:'인사하다', ro:'a saluta', en:'to greet', aliases:['salută','saluta','greet'], final:'인사해요', forms:{none:'인사해요',seq:'인사하고',cause1:'인사해서',cause2:'인사하니까',condition:'인사하면',contrast1:'인사하지만',contrast2:'인사하는데',purpose:'인사하려고',result:'인사해서 그렇게 되다'}},
      {ko:'입학하다', ro:'a fi admis, a intra la', en:'to enter school, to enroll', aliases:['e admis','fi admis','intra la','enter school','enroll'], final:'입학해요', forms:{none:'입학해요',seq:'입학하고',cause1:'입학해서',cause2:'입학하니까',condition:'입학하면',contrast1:'입학하지만',contrast2:'입학하는데',purpose:'입학하려고',result:'입학해서 그렇게 되다'}},
      {ko:'잊어버리다', ro:'a uita (de tot)', en:'to forget (completely)', aliases:['uită','uita','forget'], final:'잊어버려요', forms:{none:'잊어버려요',seq:'잊어버리고',cause1:'잊어버려서',cause2:'잊어버리니까',condition:'잊어버리면',contrast1:'잊어버리지만',contrast2:'잊어버리는데',purpose:'잊어버리려고',result:'잊어버려서 그렇게 되다'}},
      {ko:'자라다', ro:'a crește, a se matura', en:'to grow up', aliases:['crește','matura','grow up'], final:'자라요', forms:{none:'자라요',seq:'자라고',cause1:'자라서',cause2:'자라니까',condition:'자라면',contrast1:'자라지만',contrast2:'자라는데',purpose:'자라려고',result:'자라서 그렇게 되다'}},
      {ko:'자르다', ro:'a tăia', en:'to cut', aliases:['taie','tăia','cut'], final:'잘라요', forms:{none:'잘라요',seq:'자르고',cause1:'잘라서',cause2:'자르니까',condition:'자르면',contrast1:'자르지만',contrast2:'자르는데',purpose:'자르려고',result:'잘라서 그렇게 되다'}},
      {ko:'잠이 들다', ro:'a adormi', en:'to fall asleep', aliases:['adoarme','adormi','fall asleep'], final:'잠이 들어요', forms:{none:'잠이 들어요',seq:'잠이 들고',cause1:'잠이 들어서',cause2:'잠이 드니까',condition:'잠이 들면',contrast1:'잠이 들지만',contrast2:'잠이 드는데',purpose:'잠이 들려고',result:'잠이 들어서 그렇게 되다'}},
      {ko:'잡다', ro:'a apuca, a prinde', en:'to grab, to catch', aliases:['apucă','apuca','prinde','grab','catch'], final:'잡아요', forms:{none:'잡아요',seq:'잡고',cause1:'잡아서',cause2:'잡으니까',condition:'잡으면',contrast1:'잡지만',contrast2:'잡는데',purpose:'잡으려고',result:'잡아서 그렇게 되다'}},
      {ko:'재료를 준비하다', ro:'a pregăti ingredientele', en:'to prepare ingredients', aliases:['pregătește ingredientele','pregăti ingredientele','prepare ingredients'], final:'재료를 준비해요', forms:{none:'재료를 준비해요',seq:'재료를 준비하고',cause1:'재료를 준비해서',cause2:'재료를 준비하니까',condition:'재료를 준비하면',contrast1:'재료를 준비하지만',contrast2:'재료를 준비하는데',purpose:'재료를 준비하려고',result:'재료를 준비해서 그렇게 되다'}},
      {ko:'저장하다', ro:'a salva', en:'to save', aliases:['salvează','salva','save'], final:'저장해요', forms:{none:'저장해요',seq:'저장하고',cause1:'저장해서',cause2:'저장하니까',condition:'저장하면',contrast1:'저장하지만',contrast2:'저장하는데',purpose:'저장하려고',result:'저장해서 그렇게 되다'}},
      {ko:'전화기를 끄다', ro:'a opri telefonul', en:'to turn off the phone', aliases:['oprește telefonul','opri telefonul','turn off the phone'], final:'전화기를 꺼요', forms:{none:'전화기를 꺼요',seq:'전화기를 끄고',cause1:'전화기를 꺼서',cause2:'전화기를 끄니까',condition:'전화기를 끄면',contrast1:'전화기를 끄지만',contrast2:'전화기를 끄는데',purpose:'전화기를 끄려고',result:'전화기를 꺼서 그렇게 되다'}},
      {ko:'전화하다', ro:'a telefona', en:'to call (phone)', aliases:['telefonează','telefona','call'], final:'전화해요', forms:{none:'전화해요',seq:'전화하고',cause1:'전화해서',cause2:'전화하니까',condition:'전화하면',contrast1:'전화하지만',contrast2:'전화하는데',purpose:'전화하려고',result:'전화해서 그렇게 되다'}},
      {ko:'접다', ro:'a împături', en:'to fold', aliases:['împăturește','împături','fold'], final:'접어요', forms:{none:'접어요',seq:'접고',cause1:'접어서',cause2:'접으니까',condition:'접으면',contrast1:'접지만',contrast2:'접는데',purpose:'접으려고',result:'접어서 그렇게 되다'}},
      {ko:'조심하다', ro:'a fi atent, a fi precaut', en:'to be careful', aliases:['e atent','fi atent','fi precaut','be careful'], final:'조심해요', forms:{none:'조심해요',seq:'조심하고',cause1:'조심해서',cause2:'조심하니까',condition:'조심하면',contrast1:'조심하지만',contrast2:'조심하는데',purpose:'조심하려고',result:'조심해서 그렇게 되다'}},
      {ko:'조용히 하다', ro:'a fi liniștit', en:'to be quiet', aliases:['e liniștit','fi liniștit','be quiet'], final:'조용히 해요', forms:{none:'조용히 해요',seq:'조용히 하고',cause1:'조용히 해서',cause2:'조용히 하니까',condition:'조용히 하면',contrast1:'조용히 하지만',contrast2:'조용히 하는데',purpose:'조용히 하려고',result:'조용히 해서 그렇게 되다'}},
      {ko:'주문하다', ro:'a comanda', en:'to order (food, etc.)', aliases:['comandă','comanda','order'], final:'주문해요', forms:{none:'주문해요',seq:'주문하고',cause1:'주문해서',cause2:'주문하니까',condition:'주문하면',contrast1:'주문하지만',contrast2:'주문하는데',purpose:'주문하려고',result:'주문해서 그렇게 되다'}},
      {ko:'죽다', ro:'a muri', en:'to die', aliases:['moare','muri','die'], final:'죽어요', forms:{none:'죽어요',seq:'죽고',cause1:'죽어서',cause2:'죽으니까',condition:'죽으면',contrast1:'죽지만',contrast2:'죽는데',purpose:'죽으려고',result:'죽어서 그렇게 되다'}},
      {ko:'줄어들다', ro:'a scădea / a se micșora', en:'to decrease', aliases:['scade','scădea','micșora','decrease'], final:'줄어들어요', forms:{none:'줄어들어요',seq:'줄어들고',cause1:'줄어들어서',cause2:'줄어드니까',condition:'줄어들면',contrast1:'줄어들지만',contrast2:'줄어드는데',purpose:'줄어들려고',result:'줄어들어서 그렇게 되다'}},
      {ko:'줄이다', ro:'a reduce, a micșora', en:'to reduce, to decrease', aliases:['reduce','micșora','decrease'], final:'줄여요', forms:{none:'줄여요',seq:'줄이고',cause1:'줄여서',cause2:'줄이니까',condition:'줄이면',contrast1:'줄이지만',contrast2:'줄이는데',purpose:'줄이려고',result:'줄여서 그렇게 되다'}},
      {ko:'지나가다', ro:'a trece pe lângă', en:'to pass by', aliases:['trece pe lângă','pass by'], final:'지나가요', forms:{none:'지나가요',seq:'지나가고',cause1:'지나가서',cause2:'지나가니까',condition:'지나가면',contrast1:'지나가지만',contrast2:'지나가는데',purpose:'지나가려고',result:'지나가서 그렇게 되다'}},
      {ko:'지다', ro:'a pierde (un joc)', en:'to lose (a game)', aliases:['pierde','lose'], final:'져요', forms:{none:'져요',seq:'지고',cause1:'져서',cause2:'지니까',condition:'지면',contrast1:'지지만',contrast2:'지는데',purpose:'지려고',result:'져서 그렇게 되다'}},
      {ko:'지불하다', ro:'a plăti', en:'to pay', aliases:['plătește','plăti','pay'], final:'지불해요', forms:{none:'지불해요',seq:'지불하고',cause1:'지불해서',cause2:'지불하니까',condition:'지불하면',contrast1:'지불하지만',contrast2:'지불하는데',purpose:'지불하려고',result:'지불해서 그렇게 되다'}},
      {ko:'지워지다', ro:'a se șterge (machiaj)', en:'to come off (makeup)', aliases:['se șterge','șterge','come off'], final:'지워져요', forms:{none:'지워져요',seq:'지워지고',cause1:'지워져서',cause2:'지워지니까',condition:'지워지면',contrast1:'지워지지만',contrast2:'지워지는데',purpose:'지워지려고',result:'지워져서 그렇게 되다'}},
      {ko:'집중하다', ro:'a se concentra', en:'to concentrate, to focus', aliases:['se concentrează','concentra','concentrate','focus'], final:'집중해요', forms:{none:'집중해요',seq:'집중하고',cause1:'집중해서',cause2:'집중하니까',condition:'집중하면',contrast1:'집중하지만',contrast2:'집중하는데',purpose:'집중하려고',result:'집중해서 그렇게 되다'}},
      {ko:'찍다', ro:'a fotografia, a ștampila', en:'to take a photo, to stamp', aliases:['fotografiază','fotografia','ștampila','take a photo','stamp'], final:'찍어요', forms:{none:'찍어요',seq:'찍고',cause1:'찍어서',cause2:'찍으니까',condition:'찍으면',contrast1:'찍지만',contrast2:'찍는데',purpose:'찍으려고',result:'찍어서 그렇게 되다'}},
      {ko:'참다', ro:'a îndura, a se abține', en:'to endure, to hold back', aliases:['îndură','îndura','abține','endure','hold back'], final:'참아요', forms:{none:'참아요',seq:'참고',cause1:'참아서',cause2:'참으니까',condition:'참으면',contrast1:'참지만',contrast2:'참는데',purpose:'참으려고',result:'참아서 그렇게 되다'}},
      {ko:'참석하다', ro:'a participa (la un eveniment)', en:'to attend', aliases:['participă','participa','attend'], final:'참석해요', forms:{none:'참석해요',seq:'참석하고',cause1:'참석해서',cause2:'참석하니까',condition:'참석하면',contrast1:'참석하지만',contrast2:'참석하는데',purpose:'참석하려고',result:'참석해서 그렇게 되다'}},
      {ko:'챙기다', ro:'a pregăti, a lua cu sine', en:'to pack, to bring', aliases:['pregătește','pregăti','lua cu sine','pack','bring'], final:'챙겨요', forms:{none:'챙겨요',seq:'챙기고',cause1:'챙겨서',cause2:'챙기니까',condition:'챙기면',contrast1:'챙기지만',contrast2:'챙기는데',purpose:'챙기려고',result:'챙겨서 그렇게 되다'}},
      {ko:'척하다', ro:'a se preface', en:'to pretend', aliases:['se preface','preface','pretend'], final:'척해요', forms:{none:'척해요',seq:'척하고',cause1:'척해서',cause2:'척하니까',condition:'척하면',contrast1:'척하지만',contrast2:'척하는데',purpose:'척하려고',result:'척해서 그렇게 되다'}},
      {ko:'쳐다보다', ro:'a se uita fix, a privi insistent', en:'to stare at', aliases:['se uită fix','uita fix','privi insistent','stare at'], final:'쳐다봐요', forms:{none:'쳐다봐요',seq:'쳐다보고',cause1:'쳐다봐서',cause2:'쳐다보니까',condition:'쳐다보면',contrast1:'쳐다보지만',contrast2:'쳐다보는데',purpose:'쳐다보려고',result:'쳐다봐서 그렇게 되다'}},
      {ko:'초대하다', ro:'a invita', en:'to invite', aliases:['invită','invita','invite'], final:'초대해요', forms:{none:'초대해요',seq:'초대하고',cause1:'초대해서',cause2:'초대하니까',condition:'초대하면',contrast1:'초대하지만',contrast2:'초대하는데',purpose:'초대하려고',result:'초대해서 그렇게 되다'}},
      {ko:'추천하다', ro:'a recomanda', en:'to recommend', aliases:['recomandă','recomanda','recommend'], final:'추천해요', forms:{none:'추천해요',seq:'추천하고',cause1:'추천해서',cause2:'추천하니까',condition:'추천하면',contrast1:'추천하지만',contrast2:'추천하는데',purpose:'추천하려고',result:'추천해서 그렇게 되다'}},
      {ko:'축하하다', ro:'a felicita', en:'to congratulate', aliases:['felicită','felicita','congratulate'], final:'축하해요', forms:{none:'축하해요',seq:'축하하고',cause1:'축하해서',cause2:'축하하니까',condition:'축하하면',contrast1:'축하하지만',contrast2:'축하하는데',purpose:'축하하려고',result:'축하해서 그렇게 되다'}},
      {ko:'출근하다', ro:'a merge la muncă', en:'to go to work', aliases:['merge la muncă','go to work'], final:'출근해요', forms:{none:'출근해요',seq:'출근하고',cause1:'출근해서',cause2:'출근하니까',condition:'출근하면',contrast1:'출근하지만',contrast2:'출근하는데',purpose:'출근하려고',result:'출근해서 그렇게 되다'}},
      {ko:'출발하다', ro:'a pleca, a porni', en:'to depart, to set off', aliases:['pleacă','pleca','porni','depart','set off'], final:'출발해요', forms:{none:'출발해요',seq:'출발하고',cause1:'출발해서',cause2:'출발하니까',condition:'출발하면',contrast1:'출발하지만',contrast2:'출발하는데',purpose:'출발하려고',result:'출발해서 그렇게 되다'}},
      {ko:'춤추다', ro:'a dansa', en:'to dance', aliases:['dansează','dansa','dance'], final:'춤춰요', forms:{none:'춤춰요',seq:'춤추고',cause1:'춤춰서',cause2:'춤추니까',condition:'춤추면',contrast1:'춤추지만',contrast2:'춤추는데',purpose:'춤추려고',result:'춤춰서 그렇게 되다'}},
      {ko:'취소하다', ro:'a anula', en:'to cancel', aliases:['anulează','anula','cancel'], final:'취소해요', forms:{none:'취소해요',seq:'취소하고',cause1:'취소해서',cause2:'취소하니까',condition:'취소하면',contrast1:'취소하지만',contrast2:'취소하는데',purpose:'취소하려고',result:'취소해서 그렇게 되다'}},
      {ko:'취직하다', ro:'a-și găsi un loc de muncă', en:'to get a job', aliases:['își găsește un loc de muncă','găsi un loc de muncă','get a job'], final:'취직해요', forms:{none:'취직해요',seq:'취직하고',cause1:'취직해서',cause2:'취직하니까',condition:'취직하면',contrast1:'취직하지만',contrast2:'취직하는데',purpose:'취직하려고',result:'취직해서 그렇게 되다'}},
      {ko:'치다', ro:'a lovi, a juca sport', en:'to hit, to play (sport)', aliases:['lovește','lovi','juca sport','hit','play'], final:'쳐요', forms:{none:'쳐요',seq:'치고',cause1:'쳐서',cause2:'치니까',condition:'치면',contrast1:'치지만',contrast2:'치는데',purpose:'치려고',result:'쳐서 그렇게 되다'}},
      {ko:'커피를 마시다', ro:'a bea cafea', en:'to drink coffee', aliases:['bea cafea','drink coffee'], final:'커피를 마셔요', forms:{none:'커피를 마셔요',seq:'커피를 마시고',cause1:'커피를 마셔서',cause2:'커피를 마시니까',condition:'커피를 마시면',contrast1:'커피를 마시지만',contrast2:'커피를 마시는데',purpose:'커피를 마시려고',result:'커피를 마셔서 그렇게 되다'}},
      {ko:'켜다', ro:'a aprinde, a porni', en:'to turn on', aliases:['aprinde','porni','turn on'], final:'켜어요', forms:{none:'켜어요',seq:'켜고',cause1:'켜어서',cause2:'켜니까',condition:'켜면',contrast1:'켜지만',contrast2:'켜는데',purpose:'켜려고',result:'켜어서 그렇게 되다'}},
      {ko:'태어나다', ro:'a se naște', en:'to be born', aliases:['se naște','naște','be born'], final:'태어나요', forms:{none:'태어나요',seq:'태어나고',cause1:'태어나서',cause2:'태어나니까',condition:'태어나면',contrast1:'태어나지만',contrast2:'태어나는데',purpose:'태어나려고',result:'태어나서 그렇게 되다'}},
      {ko:'태우다', ro:'a arde ceva / a duce cu mașina', en:'to burn something / to give a ride', aliases:['arde ceva','duce cu mașina','burn something','give a ride'], final:'태워요', forms:{none:'태워요',seq:'태우고',cause1:'태워서',cause2:'태우니까',condition:'태우면',contrast1:'태우지만',contrast2:'태우는데',purpose:'태우려고',result:'태워서 그렇게 되다'}},
      {ko:'퇴근하다', ro:'a pleca de la muncă', en:'to leave work', aliases:['pleacă de la muncă','pleca de la muncă','leave work'], final:'퇴근해요', forms:{none:'퇴근해요',seq:'퇴근하고',cause1:'퇴근해서',cause2:'퇴근하니까',condition:'퇴근하면',contrast1:'퇴근하지만',contrast2:'퇴근하는데',purpose:'퇴근하려고',result:'퇴근해서 그렇게 되다'}},
      {ko:'퇴직하다', ro:'a se pensiona, a demisiona', en:'to retire, to resign', aliases:['se pensionează','pensiona','demisiona','retire','resign'], final:'퇴직해요', forms:{none:'퇴직해요',seq:'퇴직하고',cause1:'퇴직해서',cause2:'퇴직하니까',condition:'퇴직하면',contrast1:'퇴직하지만',contrast2:'퇴직하는데',purpose:'퇴직하려고',result:'퇴직해서 그렇게 되다'}},
      {ko:'투자하다', ro:'a investi', en:'to invest', aliases:['investește','investi','invest'], final:'투자해요', forms:{none:'투자해요',seq:'투자하고',cause1:'투자해서',cause2:'투자하니까',condition:'투자하면',contrast1:'투자하지만',contrast2:'투자하는데',purpose:'투자하려고',result:'투자해서 그렇게 되다'}},
      {ko:'펴다', ro:'a desface / a întinde', en:'to unfold / to spread out', aliases:['desface','întinde','unfold','spread out'], final:'펴어요', forms:{none:'펴어요',seq:'펴고',cause1:'펴어서',cause2:'펴니까',condition:'펴면',contrast1:'펴지만',contrast2:'펴는데',purpose:'펴려고',result:'펴어서 그렇게 되다'}},
      {ko:'포장하다', ro:'a împacheta', en:'to wrap / to pack', aliases:['împachetează','împacheta','wrap','pack'], final:'포장해요', forms:{none:'포장해요',seq:'포장하고',cause1:'포장해서',cause2:'포장하니까',condition:'포장하면',contrast1:'포장하지만',contrast2:'포장하는데',purpose:'포장하려고',result:'포장해서 그렇게 되다'}},
      {ko:'포함하다', ro:'a include', en:'to include', aliases:['include'], final:'포함해요', forms:{none:'포함해요',seq:'포함하고',cause1:'포함해서',cause2:'포함하니까',condition:'포함하면',contrast1:'포함하지만',contrast2:'포함하는데',purpose:'포함하려고',result:'포함해서 그렇게 되다'}},
      {ko:'풀다', ro:'a dezlega / a rezolva', en:'to untie / to solve', aliases:['dezleagă','dezlega','rezolva','untie','solve'], final:'풀어요', forms:{none:'풀어요',seq:'풀고',cause1:'풀어서',cause2:'푸니까',condition:'풀면',contrast1:'풀지만',contrast2:'푸는데',purpose:'풀려고',result:'풀어서 그렇게 되다'}},
      {ko:'하다', ro:'a face', en:'to do', aliases:['face','do'], final:'해요', forms:{none:'해요',seq:'하고',cause1:'해서',cause2:'하니까',condition:'하면',contrast1:'하지만',contrast2:'하는데',purpose:'하려고',result:'해서 그렇게 되다'}},
      {ko:'합격하다', ro:'a trece un examen', en:'to pass an exam', aliases:['trece un examen','pass an exam'], final:'합격해요', forms:{none:'합격해요',seq:'합격하고',cause1:'합격해서',cause2:'합격하니까',condition:'합격하면',contrast1:'합격하지만',contrast2:'합격하는데',purpose:'합격하려고',result:'합격해서 그렇게 되다'}},
      {ko:'해내다', ro:'a reuși, a duce la bun sfârșit', en:'to accomplish, to succeed', aliases:['reușește','reuși','duce la bun sfârșit','accomplish','succeed'], final:'해내어요', forms:{none:'해내어요',seq:'해내고',cause1:'해내어서',cause2:'해내니까',condition:'해내면',contrast1:'해내지만',contrast2:'해내는데',purpose:'해내려고',result:'해내어서 그렇게 되다'}},
      {ko:'향상시키다', ro:'a îmbunătăți, a ridica nivelul', en:'to improve, to enhance', aliases:['îmbunătățește','îmbunătăți','ridica nivelul','improve','enhance'], final:'향상시켜요', forms:{none:'향상시켜요',seq:'향상시키고',cause1:'향상시켜서',cause2:'향상시키니까',condition:'향상시키면',contrast1:'향상시키지만',contrast2:'향상시키는데',purpose:'향상시키려고',result:'향상시켜서 그렇게 되다'}},
      {ko:'허락하다', ro:'a permite', en:'to allow', aliases:['permite','allow'], final:'허락해요', forms:{none:'허락해요',seq:'허락하고',cause1:'허락해서',cause2:'허락하니까',condition:'허락하면',contrast1:'허락하지만',contrast2:'허락하는데',purpose:'허락하려고',result:'허락해서 그렇게 되다'}},
      {ko:'헤어지다', ro:'a se despărți', en:'to break up / to part', aliases:['se desparte','despărți','break up','part'], final:'헤어져요', forms:{none:'헤어져요',seq:'헤어지고',cause1:'헤어져서',cause2:'헤어지니까',condition:'헤어지면',contrast1:'헤어지지만',contrast2:'헤어지는데',purpose:'헤어지려고',result:'헤어져서 그렇게 되다'}},
      {ko:'헬스장에 다니다', ro:'a merge la sală', en:'to go to the gym regularly', aliases:['merge la sală','go to the gym regularly'], final:'헬스장에 다녀요', forms:{none:'헬스장에 다녀요',seq:'헬스장에 다니고',cause1:'헬스장에 다녀서',cause2:'헬스장에 다니니까',condition:'헬스장에 다니면',contrast1:'헬스장에 다니지만',contrast2:'헬스장에 다니는데',purpose:'헬스장에 다니려고',result:'헬스장에 다녀서 그렇게 되다'}},
      {ko:'화장하다', ro:'a se machia', en:'to put on makeup', aliases:['se machiază','machia','put on makeup'], final:'화장해요', forms:{none:'화장해요',seq:'화장하고',cause1:'화장해서',cause2:'화장하니까',condition:'화장하면',contrast1:'화장하지만',contrast2:'화장하는데',purpose:'화장하려고',result:'화장해서 그렇게 되다'}},
      {ko:'화해하다', ro:'a se împăca', en:'to make up, to reconcile', aliases:['se împacă','împăca','make up','reconcile'], final:'화해해요', forms:{none:'화해해요',seq:'화해하고',cause1:'화해해서',cause2:'화해하니까',condition:'화해하면',contrast1:'화해하지만',contrast2:'화해하는데',purpose:'화해하려고',result:'화해해서 그렇게 되다'}},
      {ko:'환불을 받다', ro:'a primi ramburs', en:'to get a refund', aliases:['primește ramburs','primi ramburs','get a refund'], final:'환불을 받아요', forms:{none:'환불을 받아요',seq:'환불을 받고',cause1:'환불을 받아서',cause2:'환불을 받으니까',condition:'환불을 받으면',contrast1:'환불을 받지만',contrast2:'환불을 받는데',purpose:'환불을 받으려고',result:'환불을 받아서 그렇게 되다'}},
      {ko:'환전하다', ro:'a schimba valută', en:'to exchange currency', aliases:['schimbă valută','schimba valută','exchange currency'], final:'환전해요', forms:{none:'환전해요',seq:'환전하고',cause1:'환전해서',cause2:'환전하니까',condition:'환전하면',contrast1:'환전하지만',contrast2:'환전하는데',purpose:'환전하려고',result:'환전해서 그렇게 되다'}},
      {ko:'활용하다', ro:'a utiliza', en:'to utilize', aliases:['utilizează','utiliza','utilize'], final:'활용해요', forms:{none:'활용해요',seq:'활용하고',cause1:'활용해서',cause2:'활용하니까',condition:'활용하면',contrast1:'활용하지만',contrast2:'활용하는데',purpose:'활용하려고',result:'활용해서 그렇게 되다'}},
      {ko:'후회하다', ro:'a regreta', en:'to regret', aliases:['regretă','regreta','regret'], final:'후회해요', forms:{none:'후회해요',seq:'후회하고',cause1:'후회해서',cause2:'후회하니까',condition:'후회하면',contrast1:'후회하지만',contrast2:'후회하는데',purpose:'후회하려고',result:'후회해서 그렇게 되다'}},
      {ko:'흔들다', ro:'a scutura / a agita', en:'to shake', aliases:['scutură','scutura','agita','shake'], final:'흔들어요', forms:{none:'흔들어요',seq:'흔들고',cause1:'흔들어서',cause2:'흔드니까',condition:'흔들면',contrast1:'흔들지만',contrast2:'흔드는데',purpose:'흔들려고',result:'흔들어서 그렇게 되다'}},
      {ko:'퇴사하다', ro:'a demisiona', en:'to leave a company', aliases:['demisionează','demisiona','leave a company'], final:'퇴사해요', forms:{none:'퇴사해요',seq:'퇴사하고',cause1:'퇴사해서',cause2:'퇴사하니까',condition:'퇴사하면',contrast1:'퇴사하지만',contrast2:'퇴사하는데',purpose:'퇴사하려고',result:'퇴사해서 그렇게 되다'}},
      {ko:'지치다', ro:'a se epuiza', en:'to get exhausted', aliases:['se epuizează','epuiza','get exhausted'], final:'지쳐요', forms:{none:'지쳐요',seq:'지치고',cause1:'지쳐서',cause2:'지치니까',condition:'지치면',contrast1:'지치지만',contrast2:'지치는데',purpose:'지치려고',result:'지쳐서 그렇게 되다'}},
      {ko:'충전하다', ro:'a încărca (bateria)', en:'to charge (battery)', aliases:['încarcă','încărca','charge'], final:'충전해요', forms:{none:'충전해요',seq:'충전하고',cause1:'충전해서',cause2:'충전하니까',condition:'충전하면',contrast1:'충전하지만',contrast2:'충전하는데',purpose:'충전하려고',result:'충전해서 그렇게 되다'}},
    ],
    connector: [
