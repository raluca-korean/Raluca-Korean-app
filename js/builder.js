(function(){
  ...
  var DATA = {
    ...
    verb: [
      ...
      {ko:'계시다', ro:'a fi, a sta (onorific)', en:'to be, to stay (honorific)', aliases:['sunt','ești','este','suntem','sunteți','am fost','ai fost','a fost','ați fost','au fost','fi','sta','be','stay'], final:'계셔요', forms:{none:'계셔요',seq:'계시고',cause1:'계셔서',cause2:'계시니까',condition:'계시면',contrast1:'계시지만',contrast2:'계시는데',purpose:'계시려고',result:'계셔서 그렇게 되다'}},
