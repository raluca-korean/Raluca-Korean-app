(function(){
  ...
  var DATA = {
    ...
    verb: [
      ...
      {ko:'성공하다', ro:'a reuși', en:'to succeed', aliases:['reusesc','reusesti','reuseste','reusim','reusit','am reusit','a reusit','voi reusi','vei reusi','reusi','reușesc','reușești','reușește','reușim','reușit','am reușit','a reușit','voi reuși','vei reuși','reuși','succeed','succeeds','succeeded','pass','passes','passed','will succeed'], final:'성공해요', forms:{none:'성공해요',seq:'성공하고',cause1:'성공해서',cause2:'성공하니까',condition:'성공하면',contrast1:'성공하지만',contrast2:'성공하는데',purpose:'성공하려고',result:'성공하게 되다'}},
