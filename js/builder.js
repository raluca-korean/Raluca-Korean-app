(function(){
  ...
  var DATA = {
    ...
    verb: [
      ...
      {ko:'배가 고프다', ro:'a fi flămând', en:'to be hungry', aliases:['sunt flămând','ești flămând','este flămând','suntem flămânzi','sunteți flămânzi','sunt flămânzi','am fost flămând','ai fost flămând','a fost flămând','am fost flămânzi','ați fost flămânzi','au fost flămânzi','fi flămând','be hungry','is hungry'], final:'배가 고파요', forms:{none:'배가 고파요',seq:'배가 고프고',cause1:'배가 고파서',cause2:'배가 고프니까',condition:'배가 고프면',contrast1:'배가 고프지만',contrast2:'배가 고프는데',purpose:'배가 고프려고',result:'배가 고파서 그렇게 되다'}},
