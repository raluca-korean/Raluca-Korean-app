/* ============================================================
   PARSER ENGINE (RO / EN → structură frază coreeană)
   - normalize: elimină diacritice + lowercase
   - tokenize: împarte în cuvinte
   - parse: detectează subiect, timp, loc, obiect, verb, conjugare
============================================================ */
